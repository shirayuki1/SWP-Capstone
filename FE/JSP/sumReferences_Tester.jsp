<%-- 
    Document   : sumReferences_Tester
    Created on : Nov 5, 2022, 1:07:09 PM
    Author     : phuon
--%>
                    ...
                    <div id="content-inner" class="content-inner goals-clear">
                        ...
                        <div class="report-box report-box-highlighted icon-form-32">
                            ...
                            <div class="report-box-intro">
                                ...
                                <p style="margin-bottom: 0">Shows a summary of found defects for references and their test cases in a coverage matrix. Please see the Report Options section below to configure the report specific options.</p>
                            </div>
                        </div>
                        ...
                        <form action="index.php?/reports/add_job/1&amp;plugin=references_defect_summary" method="post"><input type="hidden" name="_token" value="gCV.f8MUIRR8sCSI3bSb">
                            <div class="form-group form-group-main">
                                <label for="name">Name		<span class="form-required">*</span></label>
                                <input class="form-control " type="text" name="name" id="name" maxlength="250" value="Summary for References (Defects) %date%">
                            ...
                            <div class="report-form">
                                ...
                                <div class="tabs">
                                    <div class="tab-header">
                                        <a href="javascript:void(0)" class="tab1 current" rel="1" onclick="App.Tabs.activate(this)">References</a>
                                        <a href="javascript:void(0)" class="tab2 " rel="2" onclick="App.Tabs.activate(this)">
                                            Sections &amp; Test Runs					</a>
                                        <a href="javascript:void(0)" class="tab3 " rel="3" onclick="App.Tabs.activate(this)">Test Cases</a>
                                    </div>
                                    <div class="tab-body tab-frame">
                                        <div class="tab tab1 ">


                                            <p class="top">Include the following references:</p>
                                            <div class="radio form-radio" style="margin-left: 15px">
                                                <label>
                                                    All references		<input type="radio" id="custom_references_include_all" name="custom_references_include" value="1" checked="checked">
                                                </label>
                                            </div>
                                            <div class="radio form-radio" style="margin-left: 15px">
                                                <label>
                                                    The following references only:		<input type="radio" id="custom_references_include_selected" name="custom_references_include" value="2">
                                                </label>
                                            </div>
                                            <div style="margin-left: 35px">
                                                <textarea class="form-control form-control-full processed " id="custom_references_ids" name="custom_references_ids" rows="10" style="height: 150px"></textarea>
                                                <div class="form-description">Please enter one reference ID per line.</div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="tab tab3 hidden">
                                            ...
                                            <div class="checkbox form-checkbox" style="margin-left: 15px">
                                                <label>
                                                    The defects for each selected test run / result <em>(comparison)</em>					<input type="checkbox" id="custom_cases_include_comparison" name="custom_cases_include_comparison" value="1" checked="checked">
                                                </label>
                                            </div>
                                            <div class="checkbox" style="margin-left: 15px">
                                                <label>
                                                    The combined defect summary for the selected test runs <em>(summary)</em>					<input type="checkbox" id="custom_cases_include_summary" name="custom_cases_include_summary" value="1" checked="checked">
                                                </label>
                                            </div>
                                ...
                                <div class="dialog-body">
                                    <div class="form-group bottom">
                                        ...
                                        <select class="form-control form-control-full form-select" name="addColumnItems" id="addColumnItems">
                                            ...
                                            <option id="addColumn-cases:created_by" value="cases:created_by">
                                                Created By					</option>
                                            ...
                                            <option id="addColumn-cases:type_id" value="cases:type_id">
                                                Type					</option>
                                            <option id="addColumn-cases:updated_by" value="cases:updated_by">
                                                Updated By					</option>
