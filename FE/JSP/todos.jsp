<%-- 
    Document   : todos
    Created on : Oct 25, 2022, 8:18:18 PM
    Author     : phuon
--%>
                                    ...
                                    <div class="checkbox-list-inner">
                                        ...
                                        <div class="checkbox checkbox-list-item" id="userSelection_checkbox-1">
                                            <label>
                                                ...
                                                <input name="userSelection[]" id="userSelection-1" type="checkbox" value="2" class="checkbox-list-input">
                                            </label>
                                        </div>
                                        <div class="checkbox checkbox-list-item" id="userSelection_checkbox-2">
                                            <label>
                                                <span class="checkbox-name text-ppp">Do Thanh Tu</span>
                                                <input name="userSelection[]" id="userSelection-2" type="checkbox" checked="checked" value="1" class="checkbox-list-input">
                                            </label>
                                        </div>
                                    </div>
                                </div>
