<%-- 
    Document   : statusTops_Tester
    Created on : Nov 5, 2022, 1:06:03 PM
    Author     : phuon
--%>
                    ...
                    <div id="content-inner" class="content-inner goals-clear">
                        ...
                        <div class="report-box report-box-highlighted icon-form-32">
                            ...
                            <div class="report-box-intro">
                                ...
                                <p style="margin-bottom: 0">Shows the test cases with the highest amount of results for the selected statuses, grouped by status. Please see the Report Options section below to configure the report specific options.</p>
                            </div>
                        </div>
                        ...
                        <form action="index.php?/reports/add_job/1&amp;plugin=cases_status_tops" method="post"><input type="hidden" name="_token" value="5cMtXCbRHk4p2BzVekok">
                            <div class="form-group form-group-main">
                                <label for="name">Name		<span class="form-required">*</span></label>
                                <input class="form-control " type="text" name="name" id="name" maxlength="250" value="Status Tops (Cases) %date%">
                            ...
                            <div class="report-form">
                                ...
                                <div class="tabs">
                                    <div class="tab-header">
                                        <a href="javascript:void(0)" class="tab1 current" rel="1" onclick="App.Tabs.activate(this)">Statuses &amp; Results</a>
                                    ...
                                    <div class="tab-body tab-frame">
                                        <div class="tab tab1 ">
                                            ...
                                            <p class="top">Include the following statuses:</p>
                                            <div class="radio form-radio" style="margin-left: 15px">
                                                <label>
                                                    All statuses		<input type="radio" id="custom_statuses_include_all" name="custom_statuses_include" value="1" checked="checked">
                                                </label>
                                            </div>
                                            <div class="radio form-radio" style="margin-left: 15px">
                                                <label>
                                                    The following statuses only:		<input type="radio" id="custom_statuses_include_selected" name="custom_statuses_include" value="2">
                                                </label>
                                            </div>
                                            <div style="margin-left: 35px">
                                                <select class="form-control form-select " id="custom_statuses_ids" name="custom_statuses_ids[]" style="width: 100%; height: 200px" multiple="multiple">
                                            ...
                                            <p class="">Include the following results:</p>
                                            <div class="radio form-radio" style="margin-left: 15px">
                                                <label>
                                                    All test results of the tests		<input type="radio" id="custom_results_include_all" name="custom_results_include" value="1" checked="checked">
                                                </label>
                                            </div>
                                            <div class="radio" style="margin-left: 15px">
                                                <label>
                                                    The latest test results per test only (current status)		<input type="radio" id="custom_results_include_selected" name="custom_results_include" value="2">
                                                </label>
                                            </div>
                                        </div>
                                        ...
                                        <div class="tab tab3 hidden">
                                            ...
                                            <p class="">Maximum number of test cases to display (per status):</p>
                                            <div style="margin-left: 15px">
