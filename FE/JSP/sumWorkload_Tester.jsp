<%-- 
    Document   : sumWorkload_Tester
    Created on : Nov 5, 2022, 1:09:54 PM
    Author     : phuon
--%>
                    ...
                    <div id="content-inner" class="content-inner goals-clear">
                        ...
                        <div class="report-box report-box-highlighted icon-form-32">
                            ...
                            <div class="report-box-intro">
                                ...
                                <p style="margin-bottom: 0">Shows the current workload for users for the entire project, a specific milestone or select test runs. Please see the Report Options section below to configure the report specific options.</p>
                            </div>
                        </div>
                        ...
                        <form action="index.php?/reports/add_job/1&amp;plugin=users_workload_summary" method="post"><input type="hidden" name="_token" value="z51xCVlbXxse1qTvHf/r">
                            <div class="form-group form-group-main">
                                <label for="name">Name		<span class="form-required">*</span></label>
                                <input class="form-control " type="text" name="name" id="name" maxlength="250" value="Workload Summary (Users) %date%">
                            ...
                            <div class="report-form">
                                ...
                                <div class="tabs">
                                    <div class="tab-header">
                                        <a href="javascript:void(0)" class="tab1 current" rel="1" onclick="App.Tabs.activate(this)">Users &amp; Details</a>
                                    ...
                                    <div class="tab-body tab-frame">
                                        <div class="tab tab1 ">
                                            ...
                                            <p class="top">Include the following users:</p>
                                            <div class="radio form-radio" style="margin-left: 15px">
                                                <label>
                                                    All users		<input type="radio" id="custom_users_include_all" name="custom_users_include" value="1" checked="checked">
                                                </label>
                                            </div>
                                            <div class="radio form-radio" style="margin-left: 15px">
                                                <label>
                                                    The following users only:		<input type="radio" id="custom_users_include_selected" name="custom_users_include" value="2">
                                                </label>
                                            </div>
                                            <div style="margin-left: 35px">
                                                <select class="form-control form-select " id="custom_users_ids" name="custom_users_ids[]" style="width: 100%; height: 200px" multiple="multiple">
                                            ...
                                            <div class="checkbox form-checkbox" style="margin-left: 15px">
                                                <label>
                                                    An aggregated summary of estimates &amp; forecasts					<input type="checkbox" id="custom_tests_include_summary" name="custom_tests_include_summary" value="1" checked="checked">
                                                </label>
                                            </div>
                                            <div class="checkbox" style="margin-left: 15px">
                                                <label>
                                                    The test details per user					<input type="checkbox" id="custom_tests_include_details" name="custom_tests_include_details" value="1" checked="checked">
                                                </label>
                                            </div>
                                        </div>
                                        ...
                                        <div class="tab tab3 hidden">
                                            ...
                                            <p class="">Maximum number of tests to display (per user):</p>
                                            <div style="margin-left: 15px">
