<%-- 
    Document   : defSummary_Tester
    Created on : Nov 5, 2022, 1:06:22 PM
    Author     : phuon
--%>
...
<!--                        <li class="top-menu-item"><a class="dropdownLink top-menu-highlight" id="navigation-menu" href="#helpDropdown" tabindex="-1">Help &amp; Feedback <span class="caret top-menu-highlight" style="vertical-align: 2px"></span></a>
                    ...
                    <div class="top-search">
                        <form action="index.php?/search/index/1" style="display: inline" method="post">					<input type="hidden" name="_token" value="gCV.f8MUIRR8sCSI3bSb">					<input class="top-search-control" type="text" name="query" tabindex="-1">
                        </form>			</div>
                </div>
            </div>
                    ...
                    <div id="content-inner" class="content-inner goals-clear">
                        ...
                        <div class="report-box report-box-highlighted icon-form-32">
                            ...
                            <div class="report-box-intro">
                                ...
                                <p style="margin-bottom: 0">Shows a summary of found defects for a milestone, test plan or select test runs. Please see the Report Options section below to configure the report specific options.</p>
                            </div>
                        </div>
                        ...
                        <form action="index.php?/reports/add_job/1&amp;plugin=defects_summary" method="post"><input type="hidden" name="_token" value="gCV.f8MUIRR8sCSI3bSb">
                            <div class="form-group form-group-main">
                                <label for="name">Name		<span class="form-required">*</span></label>
                                <input class="form-control " type="text" name="name" id="name" maxlength="250" value="Summary (Defects) %date%">
                            ...
                            <div class="report-form">
                                ...
                                <div class="tabs">
                                    <div class="tab-header">
                                        <a href="javascript:void(0)" class="tab1 current" rel="1" onclick="App.Tabs.activate(this)">Defects</a>
                                    ...
                                    <div class="tab-body tab-frame">
                                        <div class="tab tab1 ">
                                            ...
                                            <p class="top">Include the following defects:</p>
                                            <div class="radio form-radio" style="margin-left: 15px">
                                                <label>
                                                    All defects		<input type="radio" id="custom_defects_include_all" name="custom_defects_include" value="1" checked="checked">
                                                </label>
                                            </div>
                                            <div class="radio form-radio" style="margin-left: 15px">
                                                <label>
                                                    The following defects only:		<input type="radio" id="custom_defects_include_selected" name="custom_defects_include" value="2">
                                                </label>
                                            </div>
                                            <div style="margin-left: 35px">
                                                <textarea class="form-control form-control-full processed " id="custom_defects_ids" name="custom_defects_ids" rows="10" style="height: 150px"></textarea>
                                                <div class="form-description">Please enter one defect ID per line.</div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="tab tab3 hidden">
                                            ...
                                            <p style="margin-top: 0">Include the following columns:	<span class="form-required">*</span></p>
                                            <div style="margin-left: 15px">
                                                <div class="grid-container" style="margin-bottom: 5px">
...
person2@example.com</textarea>
        ...
        <script type="text/javascript">
            ...
            Consts.ajaxCsrf = 'gCV.f8MUIRR8sCSI3bSb';
        ...
        <div id="tooltip" class="tooltip">
            ...
            <div class="dialog-body">
                ...
                <form action="index.php?/admin/users/accept_data_processing_agreement" id="dpa_form" method="post">        <input type="hidden" name="_token" value="gCV.f8MUIRR8sCSI3bSb">
        ...
        <div class="dialog" id="trEnterpriseDialog" style="width: 350px; word-wrap: break-word">
            <div class="dialog-title"></div>
            <form action="index.php?/mysettings/tr_enterprise_banner_setting" id="tr_enterprise_form" method="post">    <input type="hidden" name="_token" value="gCV.f8MUIRR8sCSI3bSb">    <div class="dialog-body">
                    <p style="margin: 0" class="dialog-message"></p>
                    <div class="form-group">
                        <div class="radio">
                            <label>
