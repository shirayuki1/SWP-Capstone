<%-- 
    Document   : statusTops
    Created on : Nov 1, 2022, 9:09:51 PM
    Author     : phuon
--%>
    ...
    <body style="min-width: 960px" class="modern">
        ...
        <div id="header">
            <ul class="header-menu">
                <li class="header-menu-item header-menu-item-right"><a tabindex="-1" href="adminDashboard.jsp" id="navigation-admin">Administration</a></li>
