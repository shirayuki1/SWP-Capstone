<%-- 
    ...
    Created on : Oct 30, 2022, 2:25:30 PM
    Author     : phuon
--%>
            ...
            <div id="body" class="table" style="display: table;">
                <div id="content" class="column content overflow-content">
                    ...
                    <div id="content-inner" class="content-inner goals-clear">
                        ...
                        <form action="index.php?/admin/projects/edit/2" id="form" onsubmit="return App.Users.onFormSubmit(2);" method="post"><input type="hidden" name="_token" value="jc3T3ZHu.mVChnRvcV9b">
                            <div id="userAccessDropdown" class="dropdown dropdown-menu role-dropdown">
                                <ul>
                            ...
                            <div id="groupAccessDropdown" class="dropdown dropdown-menu" style="width: 125px">
                                <ul>
                            ...
                            <div class="tabs">
                                <div class="tab-header">
                                    <a id="projects-tabs-project" class="current tab1				hidden" onclick="App.Tabs.activate(this); " rel="1">
                                        Project			</a>
                                    ...
                                    <a id="users-fields-fields" class=" tab5				hidden" onclick="App.Tabs.activate(this); " rel="5">
                                        User Variables			</a>
                                    <a id="users-webhooks" class=" tab6				hidden" onclick="App.Tabs.activate(this); App.Users.showWebhookList(2);" rel="6">
                                        Webhooks			</a>
                                </div>
                                <div class="tab-body tab-frame">
                                    <div class="tab tab1  dirty-trackable">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control " type="text" name="name" id="name" maxlength="250" value="aaaa">
                                        ...
                                        <div class="form-group bottom">
                                            <div class="checkbox">
                                                <label>
                                                    <strong>This project is completed</strong>
                                                    <input id="is_completed" type="checkbox" value="1" name="is_completed">
                                                </label>
                                            </div>
                                            <div class="form-description">Shows the project in the completed project list on the dashboard. This doesn't make the project read-only (you can use the Access tab for this). </div>
                                        </div>
                                    </div>
                                    <div class="tab tab2 hidden dirty-trackable">
                                    ...
                                    <div class="tab tab3 hidden dirty-trackable">
                                            ...
                                            <div class="column" style="width: 490px">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="searchable-wrapper dropdown-size">
                                                        <select class="form-control form-control-small form-select searchable  chzn-done" name="defect_plugin" id="defect_plugin" onchange="App.Projects.onDefectPluginChange(2)" style="display: none;">
                                                            <option value=""> &nbsp; </option>
                                    ...
                                    <div class="tab tab4 hidden dirty-trackable">
                                        ...
                                        <div class="table">
                                            <div class="column" style="width: 490px">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="searchable-wrapper dropdown-size">
                                                        <select class="form-control form-control-small form-select searchable  chzn-done" name="reference_plugin" id="reference_plugin" onchange="App.Projects.onReferencePluginChange(2)" style="display: none;">
                                                            <option value=""> &nbsp; </option>
                                                            <option value="Asana">Asana</option>
                                                            <option value="Assembla">Assembla</option>
                                                            <option value="OnTime_REST">Axosoft / OnTime REST</option>
                                        ...
                                        <div class="webhooks-wrapper">
                                            <div class="webhook-list p-2" style="">
                                                ...
                                                <div class="webhook-text">
                                                    Webhooks allow external services to be notified when certain events happen. When the specified events happen, we’ll send a POST request to each of the URLs you provide. Find out more in our 
                                                    <a target="_blank" href="https://www.gurock.com/testrail/docs/integrate/webhooks/introduction" class="link">Webhooks Guide.</a><br>
                                            ...
                                            <div class="ui-dialog ui-widget ui-widget-content ui-corner-all dialog ui-draggable modal-box" tabindex="-1" role="dialog" aria-labelledby="ui-dialog-title-deleteDialog" id="dialog-ident-deleteDialog" style="display: none; z-index: 1002; outline: 0px; height: auto; width: 425px; top: 199.667px; left: -62px;">
                                                <div class="ui-dialog-titlebar ui-widget-header ui-corner-all ui-helper-clearfix" style="background: rgb(208, 68, 55);">
                                                ...
                                                <div class="dialog ui-dialog-content ui-widget-content" style="width: auto; display: block; min-height: 0px; height: auto;">
                                                    ...
                                                    <div class="button-group dialog-buttons-highlighted">
                                                        <a href="javascript:void(0)" onclick="this.blur(); App.Users.deleteWebhookByIds(2); return false;" class="button-black delete-btn-border">Delete</a>
                                            ...
                                            <div class="ui-dialog ui-widget ui-widget-content ui-corner-all dialog ui-draggable modal-box" tabindex="-1" role="dialog" aria-labelledby="ui-dialog-title-deleteDialog" id="dialog-projects-confirmation" style="display: none; z-index: 1002; outline: 0px; height: auto; width: 425px; top: 199.667px; left: -62px;">
                                                <div class="ui-dialog-titlebar ui-widget-header ui-corner-all ui-helper-clearfix" style="background: rgb(208, 68, 55);">
                                                    <span class="ui-dialog-title" id="ui-dialog-title-deleteDialog">Confirmation</span>
                                                    <a href="javascript:void(0)" onclick="this.blur(); App.Users.closeDeleteWebhookPanel(); return false;" class="ui-dialog-titlebar-close ui-corner-all" role="button">
                                                        <span class="ui-icon ui-icon-closethick">close</span>
                                                ...
                                                <div class="dialog ui-dialog-content ui-widget-content" style="width: auto; display: block; min-height: 0px; height: auto;">
                                                    ...
                                                    <div class="button-group dialog-buttons-highlighted">
                                                        <a href="javascript:void(0)" onclick="this.blur(); App.Users.confirmProjectsAllowChanges(2); return false;" class="button-test button-left">
                                                            Confirm</a>
                                            ...
                                            <div class="ui-dialog ui-widget ui-widget-content ui-corner-all dialog ui-draggable modal-box" tabindex="-1" role="dialog" aria-labelledby="ui-dialog-title-deleteDialog" id="dialog-projects-error" style="display: none; z-index: 1002; outline: 0px; height: auto; width: 425px; top: 199.667px; left: -62px;">
                                                <div class="ui-dialog-titlebar ui-widget-header ui-corner-all ui-helper-clearfix" style="background: rgb(208, 68, 55);">
                            ...
                            <div class="button-group form-buttons">
                                <button id="accept" class="button button-left button-positive button-ok" type="submit">
                                    Save Project	</button>
                                <!--                                <a href="javascript:void" onclick="this.blur(); App.Users.showWebhookList( & quot; 2 & quot; ); App.Users.onCancelPage( & quot; project.jsp ); return false;" class="button button-left button-negative button-cancel save-cancel-button" id="admin-integration-form-cancel">
                                                                    Cancel	</a>-->
                                <a href="projects.jsp"  class="button button-left button-negative button-cancel save-cancel-button" id="admin-integration-form-cancel">
                                    Cancel	</a>
                            </div>
