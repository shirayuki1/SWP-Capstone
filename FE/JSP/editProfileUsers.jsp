<%-- 
    Document   : editProfileUsers
    Created on : Oct 30, 2022, 12:35:59 PM
    Author     : phuon
--%>
            ...
            <div id="body" class="table" style="display: table;">
                <div id="content" class="column content overflow-content">
                    ...
                    <div id="content-inner" class="content-inner goals-clear">
                        ...
                        <div class="dialog mfa-Dialog" id="mfaDialog">
                        ...
                        <div class="message message-hint"><strong>Please note:</strong> You are editing your own user account.</div>


                        <form action="index.php?/admin/users/edit/1" id="form" method="post"><input type="hidden" name="_token" value="0ftHiht9hFil54HJjhBT">
...
<!--                                        <div class="form-group">
                                    ...
                                    <div class="tab tab2 dirty-trackable" style="display: none">
                                        ...
                                        <div class="form-group">
                                            <div class="form-control form-message">
                                                ...
                                                <strong class="" id="last_activity"> </strong>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="checkbox">
                                        ...
                                        <div class="form-group">
                                            <div class="checkbox" id="is_admin_checkbox">
                                                <label>
                                                    ...
                                                    <input type="checkbox" class="checkbox" id="is_admin" name="is_admin" value="1" checked="checked">
                                                </label>
                                            </div>
                                            ...
                                            <table class="grid" id="example">
                                                ...
                                                <tbody><tr class="header">
                                                    ...
                                                    <tr class="even" id="userproject-1">
                                                        ...
                                                        <td class="form-group">
                                                            <input name="assigned_project_ids[]" type="hidden" id="userprojectassignment-1" value="1">
                                                        </td>
                                                        <td class="nolink">
                                                            <span class="default_access">
                                                                Lead                                                                                                                                                </span>
                                                    ...
                                                    <tr class="odd" id="userproject-2">
                                                        ...
                                                        <td class="form-group">
                                                            <input name="assigned_project_ids[]" type="hidden" id="userprojectassignment-2" value="2">
                                                        </td>
                                                        <td class="nolink">
                                                            <span class="default_access">
                                                                Lead                                                                                                                                                </span>
                            ...
                            <div class="button-group form-buttons">
                                <button class="button button-left button-positive button-ok" type="submit" id="accept" disabled="disabled">
                                    Save User    </button>
                                <a href="adminDashboard.jsp" class="button button-left button-negative button-cancel">
                                    Cancel    </a>
                            </div>
                    ...
                    <div class="dialog" id="userPasswordDialog" style="width: 400px">
                        ...
                        <form id="userPasswordForm" class="dialogFormDefault">
                            <div class="dialog-body">
                                ...
                                <p class="top">To change the email address or password of the user, please enter your current password for verification.</p>
                                <div class="form-group bottom">
...
<!--                        <li class="sidebar-menu-item ">
                    ...
                    <div class="sidebar-h1">
                        Actions    </div>
                    <p>Force this user to change their password.</p>
                    <div class="sidebar-action ">
                        <span class="button button-negative button-delete">
                            <a href="javascript:void(0)" class="link-noline" onclick="this.blur(); var link = this; App.Dialogs.remove('Really force a password change for this user? The user will be logged out and redirected to the Login page upon their next action. This may result in lost work. If they have an API key, this will be deleted also.', 'Yes, force this user to change their password.', null, null, function() { var i = document.createElement('input');
                    i.setAttribute('type', 'hidden');
                    i.setAttribute('name', '_token');
                    i.setAttribute('value', '0ftHiht9hFil54HJjhBT');
                    var f = document.createElement('form');
                    f.style.display = 'none';
                    link.parentNode.appendChild(f);
                    f.method = 'POST';
                    f.action = 'index.php?/admin/users/force_reset_password/1';
                    f.appendChild(i);
                    f.submit(); ; }); ; return false;">Force Password Change</a>            </span>
                    </div>

                    <!--  Hiding Forget this user link for logged in users  and User ID =1 -->
        ...
        <script type="text/javascript">
            ...
            Consts.ajaxCsrf = '0ftHiht9hFil54HJjhBT';
        ...
        <div id="userDropdown" class="dropdown dropdown-menu user-menu" rel="helpMenu" style="width: 125px">
            <ul><li><a class="dropdown-menu-link" id="navigation-user-settings" href="editProfileUsers.jsp">
        ...
        <div id="tooltip" class="tooltip">
            ...
            <div class="dialog-body">
                ...
                <form action="index.php?/admin/users/accept_data_processing_agreement" id="dpa_form" method="post">        <input type="hidden" name="_token" value="0ftHiht9hFil54HJjhBT">
                    <div class="form-group">
        ...
        <div class="dialog" id="trEnterpriseDialog" style="width: 350px; word-wrap: break-word">
            <div class="dialog-title"></div>
            <form action="index.php?/mysettings/tr_enterprise_banner_setting" id="tr_enterprise_form" method="post">    <input type="hidden" name="_token" value="0ftHiht9hFil54HJjhBT">    <div class="dialog-body">
                    <p style="margin: 0" class="dialog-message"></p>
                    <div class="form-group">
                        <div class="radio">
                            <label>
