<%-- 
    Document   : viewerDashboard
    Created on : Oct 23, 2022, 6:16:57 PM
    Author     : phuon
--%>
    ...
    <body>
        ...
        <div id="header">
            <ul class="header-menu">
                ...
                <li class="header-menu-item header-menu-item-selected"><a tabindex="-1" href="viewerDashboard.jsp"
                        ...
                        <div class="content-header-inner">
                            ...
                            <span class="content-header-icon content-header-icon-combined"><a href="javascript:void(0)"
                                                                                              ...
                                                                                              onclick="this.blur(); var link = this; var i = document.createElement('input');
                                                                                                  ...
                                                                                                  f.method = 'POST';
                                                                                                  f.action = 'index.php?/dashboard/index_display/&amp;display=small';
                                                                                                  f.appendChild(i);
                                    ...
                                    <div class="icon-display-small-inactive"></div>
                                                                            ...
                                                                            tooltip-text="Displays the active projects with many details." onclick="this.blur(); var link = this; var i = document.createElement('input');
                                                                                ...
                                                                                link.parentNode.appendChild(f);
                                                                                f.method = 'POST';
                                                                                f.action = 'index.php?/dashboard/index_display&amp;display=large';
                                                                                f.appendChild(i);
                                                                                f.submit(); ; return false;">
                                            ...
                                            <div class="table chart-legend-item">
                                                ...
                                                <div class="column">
                                                    <div class="chart-legend-name text-ppp"><a
                                                            href="viewerOverviewPJ.jsp">aaaa</a></div>
                                ...
                                <div class="row project flex-projects-row" id="project-1">
                                    ...
                                    <div class="column summary-column flex-projects-2">
                                        <div class="summary-title text-ppp"
                                            ...
                                            <a href="viewerOverviewPJ.jsp" style="padding-left: 25px">aaaa</a>
                                        ...
                                        <div class="summary-links text-secondary">
                                            ...
                                            <a class="link" href="#">Test Runs</a> |
                                            <a class="link" href="#">Test Cases</a> |
