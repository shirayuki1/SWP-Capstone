<%-- 
    Document   : mySettings
    Created on : Oct 30, 2022, 1:00:05 PM
    Author     : phuon
--%>
...
<!--                    <div class="top-social">
        ...
        <div id="header">
            <ul class="header-menu">
                <li class="header-menu-item header-menu-item-right"><a tabindex="-1" href="adminOverview.jsp" id="navigation-admin">Administration</a></li><li class="header-menu-item header-menu-item-selected"><a tabindex="-1" href="adminDashboard.jsp" id="navigation-dashboard">Dashboard</a></li>	</ul>
        </div>
            ...
            <div id="body" class="table" style="display: table;">
                <div id="content" class="column content overflow-content">
                    ...
                    <div id="content-inner" class="content-inner goals-clear">
                        ...
                        <form action="index.php?/mysettings" id="form" method="post"><input type="hidden" name="_token" value="jc3T3ZHu.mVChnRvcV9b">

                            <div class="tabs ">
                                <div class="tab-header">
                                    <a href="#" class="current tab1" onclick="App.Tabs.activate(this)">User</a>
                                    <a href="#" class="tab4" onclick="App.Tabs.activate(this)">API Keys</a>
                                ...
                                <div class="tab-body tab-frame">
                                    <div class="tab tab1 dirty-trackable">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control " type="text" name="name" id="name" maxlength="250" value="Doan Khoa Bao">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control   " autocomplete="off" type="text" name="email" id="email" maxlength="250" value="doankhoabao@gmail.com">
                                        </div>
                                        <div class="form-group">
                                            <div class="checkbox">
                                                <label>
...
<!--                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="form-description">Leave empty to keep the current password.</div>
                                        </div>
                                    ...
                                    <div class="tab tab4" style="display: none">
                                        <p class="message message-help top">TMS's API is currently disabled and can be enabled
                                            by a Test Management System administrator under Administration &gt; Site Settings &gt; API.</p>
                                        <p class="top">This area lets you configure API keys
                                            to authenticate API requests (in addition to your regular Test Management System
                                            password). This is useful to access TMS's API without sharing your Test Management System
                                            password and is commonly used to integrate with other applications.
                                            <a href="https://www.gurock.com/testrail/docs/api/getting-started/accessing" target="_blank">Learn more</a></p>
                                        <div class="form-group bottom form-control-default">
                                            <table id="tokensGrid" class="grid">
                                                <colgroup>
                                                    <col>
                                                ...
                                                <tbody><tr class="header">
                                                    ...
                                                    <tr id="noTokens" class="">
                                                        <td colspan="3"><em>No API keys defined.</em>
                                                        </td>
                                                    </tr>
                                                </tbody></table>
                                            <div id="addToken" style="margin-top: 1em">
                                                <p style="margin: 0"><a tabindex="-1" href="javascript:void(0)" onclick="this.blur(); App.Users.addToken(); return false;">Add Key</a>
                                                </p>
                                            </div>
                                        </div>
                                        <input type="hidden" name="tokens" id="tokens">
                                    </div>
                                        ...
                                        <div class="empty connection-holder">
                                            <div class="empty-content empty-warning full-box">
                                                ...
                                                <div class="pull-right">
                                                    <a href="javascript:void(0)" class="asm-connect-btn disabled" data-usclientid="dxLtqMU6qr6PbTcK-zJOy8" data-euclientid="cFRO4wU6Sr6R3cbVK8w0tc" data-usapisubdomain="api" data-euapisubdomain="eu-api" data-authurl="https://%s.assembla.com/authorization?response_type=code&amp;client_id=%s" data-redirect-url="https://bababa.testrail.io/index.php?/mysettings">
                                                        Connect Account                            </a>
                            ...
                            <input type="hidden" name="verify_login" id="verify_login">
                            <input type="hidden" name="verify_password" id="verify_password">
                            ...
                            <div class="button-group form-buttons">
                                ...
                                <a href="index.php?/dashboard" class="button button-left button-negative button-cancel">
                                    Cancel    </a>
                            </div>
                        </form>
                        <script type="text/javascript">
                            $(document).ready(
                                    function() {
                                    App.Users.email = "baodkse140180@fpt.edu.vn";
                                    let current_user_email = 'baodkse140180@fpt.edu.vn';
                                    let email = 'baodkse140180@fpt.edu.vn';
                                    let edit_user = '';
                                    $('#form').submit(
                                            function() {
                                            if (!$('#verify_password').val()) {
                                            let emailValue = $('#email').val();
                                            let edit_email = edit_user
                                                    ? emailValue !== email
                                                    : emailValue !== current_user_email;
                                            if (edit_email || $('#password').val()) {
                                            App.Users.verifyPassword();
                                            return false;
                                            }
                                            }
                                            }
                        ...
                        <script type="text/javascript">
                            $(document).ready(
                                    ...
                                    $('#form').submit(
                                            function() {
                                            $('#tokens').val(App.Users.tokensToString());
                                            }
                                    )
                                    }
                            );
                        ...
                        <div class="dialog" id="userTokenDialog" style="width: 400px">
                            <div class="dialog-title">Add API Key</div>
                            <form id="userTokenForm" class="dialogFormDefault">
                                <div class="dialog-body">
                                    <div class="message message-error validationError" id="userTokenErrors"></div>
                                    <div class="form-group bottom">
                                        <label for="userTokenName">Name					<span class="form-required">*</span></label>
                                        <input class="form-control form-control-full" type="text" name="userTokenName" id="userTokenName" maxlength="250">
                                        <div class="form-description form-description-full">The name of the API key should describe the usage of the key
                                            (e.g., the name of the application or tools that use the API key).</div>
                                    </div>
                                    <div id="userTokenCode" class="message message-success bottom hidden" style="margin-top: 1em">
                                    </div>
                                </div>
                                <div class="button-group dialog-buttons-highlighted">
                                    <button id="userTokenGenerate" type="submit" class="button button-left button-positive button-add dialog-action-default">
                                        Generate Key			</button>
                                    <button id="userTokenAdd" type="submit" class="button button-left button-positive button-add" style="display: none">
                                        Add Key			</button>
                        ...
                        <div class="dialog" id="userPasswordDialog" style="width: 400px">
                            <div class="dialog-title">Enter Password</div>
                            <form id="userPasswordForm" class="dialogFormDefault">
                                <div class="dialog-body">
                                    <div class="message message-error validationError" id="userPasswordErrors"></div>
                                    <p class="top">To change your email address or password, please enter your current password
                                        for verification.</p>
                                    <div class="form-group bottom">
                                        <label for="userPassword">Password					<span class="form-required">*</span></label>
                                        <input class="form-control form-control-full" type="password" name="userPassword" id="userPassword" maxlength="250">
                                    </div>
                                </div>
                                <div class="button-group dialog-buttons-highlighted">
                                    <button id="userPasswordSubmit" type="submit" class="button button-left button-positive button-ok dialog-action-default">
                                        OK			</button>
                                    <a class="button button-left button-negative button-cancel dialog-action-close">
                                        Cancel			</a>
                                </div>
                            </form>
                        </div><div class="dialog mfa-Dialog" id="mfaDialog">
                            <div class="dialog-title">Connect Authenticator App</div>
                            <form id="qrCodeForm" class="dialogFormDefault">
                                <div class="dialog-body mfa-dialog-body">
                                    <strong id="title"></strong> Please, follow these 2 steps :			<br>
                                    <br>
                                    <strong>1. Scan the QR code with your two-factor Authenticator App in your phone or device.</strong>
                                    <br>
                                    <br>
                                    <div class="qrcode-main-container">
                                        <div class="qrcode-container">
                                            <img id="qrCode" class="image-container" src=" ">
                                        </div>

                                        <div class="secretKey-container">
                                            <span>Secret key:</span>
                                            <br>
                                            <br>
                                            <div class="secretCode-container">
                                            </div>
                                        </div>
                                    </div>
                                    <br>
                                    <br>
                                    <div class="authentication-code-heading">
                                        <strong>2. After scanning the code, enter the 6-digit authentication code displayed to verify that enrollment was successful.</strong>
                                    </div>
                                    <div class="mfa-error-msg-logo">
                                        <strong>Sorry, there was a problem</strong>
                                    </div>
                                    <div class="mfa-error-msg">
                                        Entered code is incorrect. Please try again:			</div>
                                    <br>
                                    <div class="form-group bottom">
                                        <input class="form-control form-control-full mfa-code-input" type="password" placeholder="6-digit code" id="userQrCode" maxlength="6" onkeyup="App.Users.validateMfaCode();">
                                    </div>
                                    <br>
                                </div>
                                <div class="button-group dialog-buttons-mfa">
                                    <div class="float-right">
                                        <a class="button-negative button-mfa-dialog button-left  dialog-action-close" onclick="App.Users.closeMfaDialog();">
                                            Cancel				</a>
                                        <button type="button" id="qrCodeSubmitButton" class="button-mfa-dialog button-positive  dialog-action-default" onclick="App.Users.connectAuthApp()" disabled="">
                                            Continue				</button>
                                    </div>
                                </div>
                            </form>
                        ...
                        <div class="dialog dialog-ident-deleteDialog" id="mfaDisconnectConfirmationDialog">
                            <div class="dialog-title mfa-disconnect-confirmation">Confirmation</div>
                            <div class="dialog-body">
                                <div class="msg-container">
                                    <strong id="title">Disconnect your Authenticator App?</strong>
                                    <br>
                                    To enable this security feature again, you will need to reconfigure your app.			<br>
                                    <br>
                                </div>
                            </div>
                            <div class="button-group dialog-buttons-highlighted">
                                <button id="disconectMfa" type="button" onclick="App.Users.disConnectAuthApp()" class="button button-mfa-dialog-disconnect button-left ">
                                    Disconnect		</button>
                                <a class="button button-left button-negative button-cancel dialog-action-close">
                                    Cancel		</a>
                            </div>
        ...
        <script type="text/javascript">
            ...
            Consts.ajaxCsrf = 'jc3T3ZHu.mVChnRvcV9b';
        ...
        <div id="tooltip" class="tooltip">
            ...
            <div class="dialog-body">
                ...
                <form action="index.php?/admin/users/accept_data_processing_agreement" id="dpa_form" method="post">        <input type="hidden" name="_token" value="jc3T3ZHu.mVChnRvcV9b">
                    <div class="form-group">
        ...
        <div class="dialog" id="trEnterpriseDialog" style="width: 350px; word-wrap: break-word">
            <div class="dialog-title"></div>
            <form action="index.php?/mysettings/tr_enterprise_banner_setting" id="tr_enterprise_form" method="post">    <input type="hidden" name="_token" value="jc3T3ZHu.mVChnRvcV9b">    <div class="dialog-body">
                    <p style="margin: 0" class="dialog-message"></p>
                    <div class="form-group">
                        <div class="radio">
                            <label>
