<%-- 
    Document   : coverageRef_Tester
    Created on : Nov 5, 2022, 1:05:19 PM
    Author     : phuon
--%>
                    ...
                    <div id="content-inner" class="content-inner goals-clear">
                        ...
                        <div class="report-box report-box-highlighted icon-form-32">
                            ...
                            <div class="report-box-intro">
                                ...
                                <p style="margin-bottom: 0">Shows the test case coverage for references in a coverage matrix. Please see the Report Options section below to configure the report specific options.</p>
                            </div>
                        </div>
                        ...
                        <form action="index.php?/reports/add_job/1&amp;plugin=references_case_coverage" method="post"><input type="hidden" name="_token" value="5cMtXCbRHk4p2BzVekok">
                            <div class="form-group form-group-main">
                                <label for="name">Name		<span class="form-required">*</span></label>
                                <input class="form-control " type="text" name="name" id="name" maxlength="250" value="Coverage for References (Cases) %date%">
                            ...
                            <div class="report-form">
                                ...
                                <div class="tabs">
                                    ...
                                    <div class="tab-body tab-frame">
                                        ...
                                        <div class="tab tab2 hidden" style="display: none;">
                                        ...
                                        <div class="tab tab3 hidden" style="display: none;">
                                            <p class="top">Include the following test cases:</p>
                                            <div class="checkbox form-checkbox" style="margin-left: 15px">
                                                <label>
                                                    Test cases with references					<input type="checkbox" id="custom_cases_include_refs" name="custom_cases_include_refs" value="1" checked="checked">
                                                </label>
                                            </div>
                                            <div class="checkbox" style="margin-left: 15px">
                                                <label>
                                                    Test cases without references					<input type="checkbox" id="custom_cases_include_norefs" name="custom_cases_include_norefs" value="1" checked="checked">
                                                </label>
                                            </div>
