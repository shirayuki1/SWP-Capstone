<%-- 
    Document   : sumCases_Tester
    Created on : Nov 5, 2022, 1:06:39 PM
    Author     : phuon
--%>
                    ...
                    <div id="content-inner" class="content-inner goals-clear">
                        ...
                        <div class="report-box report-box-highlighted icon-form-32">
                            ...
                            <div class="report-box-intro">
                                ...
                                <p style="margin-bottom: 0">Shows a summary of found defects for test cases in a coverage matrix. Please see the Report Options section below to configure the report specific options.</p>
                            </div>
                        </div>
                        ...
                        <form action="index.php?/reports/add_job/1&amp;plugin=cases_defect_summary" method="post"><input type="hidden" name="_token" value="gCV.f8MUIRR8sCSI3bSb">
                            <div class="form-group form-group-main">
                                <label for="name">Name		<span class="form-required">*</span></label>
                                <input class="form-control " type="text" name="name" id="name" maxlength="250" value="Summary for Cases (Defects) %date%">
                            ...
                            <div class="report-form">
                                ...
                                <div class="tabs">
                                    <div class="tab-header">
                                        ...
                                        <a href="javascript:void(0)" class="tab2 " rel="2" onclick="App.Tabs.activate(this)">Test Cases</a>
                                    </div>
                                    <div class="tab-body tab-frame">
                                        <div class="tab tab1 ">
                                            ...
                                            <input type="hidden" name="custom_runs_suites_id" value="1">
                                            ...
                                            <script type="text/javascript">
                                                ...
                                                App.ReportPlugins.Runs.Select.multiple_suites = false;
                                        ...
                                        <div class="tab tab2 hidden">
                                            ...
                                            <div class="checkbox" style="margin-left: 15px; padding-top: 0">
                                                <label>
