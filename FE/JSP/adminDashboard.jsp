<%-- 
    Document   : test
    Created on : Oct 25, 2022, 6:32:36 AM
    Author     : phuon
--%>
...
<html>
    ...
    <body>
        ...
        <div id="top">
            <div id="top-logo">
                <a href="javascript:void(0)" id="bannerLink"><img
                        src="https://static.testrail.io/7.5.4.2008/images/layout/testrail-logo.svg"></a>
            </div>
            <div class="bubble estimate-bubble" id="enterpriseBubble">
                <a class="close close-hover" href="javascript: void(0);"
                   onclick="App.Dialogs.trEnterpriseBannerConfirmNew('logo')">×</a>
                    ...
                    <div class="modules_tab_righthalf">
                        ...
                        <div id="logo_banner_desc">
                            <div class="hd_sb_txt">
                                ...
                                Test Management System Professional
                            </div>
                            <div class="hd_sb_txt">
            ...
            <div class="top-panel">
                <div class="top-panel-inner">
                    ...
                    <ul class="top-menu pull-right">
                        <li class="top-menu-item"><a id="inProgressLink" href="javascript:void(0)"
                                                     onclick="this.blur(); App.Tests.showInProgress(); return false;">Working On <span
                                    class="caret" style="vertical-align: 2px"></span></a>
                        </li>
                        <li class="top-menu-item"><a class="dropdownLink" id="navigation-user" href="#userDropdown"
                                                     title="${sessionScope.LOGIN_USERS.fullName}"><span class="navigation-username">${sessionScope.LOGIN_USERS.fullName}</span> <span class="caret"
                                                                                                           style="vertical-align: 2px"></span></a>
                        </li>
<!--                        <li class="top-menu-item"><a class="dropdownLink top-menu-highlight" id="navigation-menu"
                                                     href="#helpDropdown" tabindex="-1">Help &amp; Feedback <span
                                    class="caret top-menu-highlight" style="vertical-align: 2px"></span></a>
                        </li>-->
                    </ul>
                </div>
            </div>
        ...
        <form id="newsletterForm" target="_blank" action="https://secure.gurock.com/customers/testrail/newsletter?email="
              method="post">
        ...
        <div id="header">
            <ul class="header-menu">
                <li class="header-menu-item header-menu-item-right"><a tabindex="-1" href="adminOverview.jsp"
                                                                       id="navigation-admin">Administration</a></li>
                <li class="header-menu-item header-menu-item-selected"><a tabindex="-1" href="adminDashboard.jsp"
                                                                          id="navigation-dashboard">Dashboard</a></li>
            </ul>
        </div>
            ...
            <div id="body" class="table">
                <div id="content" class="column content overflow-content">
                    ...
                    <div id="content-header" class="content-header content-header-default">
                        <div class="content-header-inner">
                            ...
                            <span class="content-header-icon content-header-icon-combined"><a href="javascript:void(0)"
                                                                                              class="link-tooltip" tooltip-header="Compact View"
                                                                                              tooltip-text="Displays the active projects as a compact list. Useful if you have many projects."
                                                                                              onclick="this.blur(); var link = this; var i = document.createElement('input');
                                                                                                  i.setAttribute('type', 'hidden');
                                                                                                  i.setAttribute('name', '_token');
                                                                                                  i.setAttribute('value', 'EVjJWvyRW/qh6YmtD4SX');
                                    ...
                                    <div class="icon-display-small-inactive"></div>
                                </a></span><span class="content-header-icon"><a href="javascript:void(0)"
                                                                            class="link-tooltip" tooltip-header="Detail View"
                                                                            tooltip-text="Displays the active projects with many details." onclick="this.blur(); var link = this; var i = document.createElement('input');
                                                                                i.setAttribute('type', 'hidden');
                                                                                i.setAttribute('name', '_token');
                                                                                i.setAttribute('value', 'EVjJWvyRW/qh6YmtD4SX');
                                                                                var f = document.createElement('form');
                                                                                ...
                                                                                link.parentNode.appendChild(f);
                                                                                f.method = 'POST';
                                                                                f.action = 'adminDashboard.jsp';
                                                                                f.appendChild(i);
                                                                                f.submit(); ; return false;">
                                    <div class="icon-display-large"></div>
                                </a></span>
                    ...
                    <div id="content-inner" class="content-inner goals-clear">
                        ...
                        <div class="dialog" id="addProjectDialog" style="width: 500px">
                            <div class="dialog-title">Add Example Project</div>
                            <form id="addProjectForm">
                                <div class="dialog-body">
                                    <p class="top message message-help">Example projects are generated by Test Management System and
                                        contain sample data
                                        such as test cases, results and milestones. They are a good way to see and use many
                                        of
                                        TMS's features and are perfect for evaluation or demonstration purposes.</p>
                                    <div class="message message-error validationError" id="addProjectErrors"></div>
                                    <div class="form-group bottom">
                                        <label for="addProjectName">
                                            Name <span class="form-required">*</span>
                                        </label>
                                        <input class="form-control form-control-full" type="text" name="addProjectName"
                                               id="addProjectName" maxlength="250" value=""
                                               placeholder="Example Project"></input>
                                        <div class="form-description form-description-full">
                                        </div>
                                    </div>
                                </div>
                                <div class="button-group dialog-buttons-highlighted">
                                    <button class="button button-left button-positive button-ok dialog-action-default"
                                            id="addProjectSubmit" type="submit">
                                        Add Example Project </button>
                        ...
                        <div class="dialog" id="selectTimeframeDialog" style="width: 400px">
                            ...
                            <form id="selectTimeframeForm">
                                <div class="dialog-body">
                                    <div class="form-group bottom">
                                        <label for="select_timeframe">Time Frame <span
                                                class="form-required">*</span></label>
                                        <select class="form-control form-control-full form-select" name="select_timeframe"
                                                id="select_timeframe">
                                ...
                                <div class="button-group dialog-buttons-highlighted">
                                    <button id="selectTimeframeSubmit"
                                            class="button button-left button-ok button-positive dialog-action-default"
                                            type="submit">
                                        OK </button>
                                    <a href="javascript:void(0)"
                                       class="button button-left button-cancel button-negative dialog-action-close">
                                        Cancel </a>
                                </div>
                            </form>
                        </div>
                        <div id="actionContainer">
                            ...
                            <div id="chart-line-fc" class="chart-line">
                                <div class="table">
                                    <div id="activityChart" class="column chart-line-dashboard"></div>
                                    <div class="column chart-line-column-legend">
                                        <div class="chart-legend">
                                            <div class="chart-legend-title">
                                                Most active (<a href="javascript:void(0)"
                                                                onclick="this.blur(); App.Dashboard.selectActionDays(); return false;"
                                                                class="link link-tooltip"
                                                                tooltip-text="Change the time frame for the chart.">14 days</a>): </div>
                                            <div class="table chart-legend-item">
                                                <div class="column column-valign chart-legend-column-icon">
                                                    <div class="chart-legend-icon" style="background: #184BB8">
                                                    </div>
                                                </div>
                                                <div class="column">
                                                    <div class="chart-legend-name text-ppp"><a
                                                            href="adminPJOverview.jsp">aaaa</a></div>
                                                    <div class="chart-legend-description text-ppp">0 recent test changes.
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="chart-icon-download-container">
                                        <div class="link-tooltip" data-html2canvas-ignore="true" tooltip-position="left"
                                             tooltip-width="170" tooltip-text="Download chart as an image">
                                            <button id="png-download"></button>
                                        </div>
                                        <div data-html2canvas-ignore="true" class="link-tooltip" tooltip-position="left"
                                             tooltip-width="150" tooltip-text="Download chart as a CSV">
                                            <button id="csv-download"></button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <a download="Test Mangement Sytem-actions-1-20221006134945.png" href="#" id="dl" hidden>download image</a>
                            ...
                            <script type="text/javascript">
                                ...
                                showLegend: '0',
                                        ...
                                        dataset: [{ "seriesname": "aaaa", "color": "#184BB8", "data": [{ "value": 0, "link": "JavaScript:App.Drilldown.changes(1,\"9\/22\", 0)", "anchorRadius": 0 }, { "value": 0, "link": "JavaScript:App.Drilldown.changes(1,\"9\/23\", 0)", "anchorRadius": 0 }, { "value": 0, "link": "JavaScript:App.Drilldown.changes(1,\"9\/24\", 0)", "anchorRadius": 0 }, { "value": 0, "link": "JavaScript:App.Drilldown.changes(1,\"9\/25\", 0)", "anchorRadius": 0 }, { "value": 0, "link": "JavaScript:App.Drilldown.changes(1,\"9\/26\", 0)", "anchorRadius": 0 }, { "value": 0, "link": "JavaScript:App.Drilldown.changes(1,\"9\/27\", 0)", "anchorRadius": 0 }, { "value": 0, "link": "JavaScript:App.Drilldown.changes(1,\"9\/28\", 0)", "anchorRadius": 0 }, { "value": 0, "link": "JavaScript:App.Drilldown.changes(1,\"9\/29\", 0)", "anchorRadius": 0 }, { "value": 0, "link": "JavaScript:App.Drilldown.changes(1,\"9\/30\", 0)", "anchorRadius": 0 }, { "value": 0, "link": "JavaScript:App.Drilldown.changes(1,\"10\/1\", 0)", "anchorRadius": 0 }, { "value": 0, "link": "JavaScript:App.Drilldown.changes(1,\"10\/2\", 0)", "anchorRadius": 0 }, { "value": 0, "link": "JavaScript:App.Drilldown.changes(1,\"10\/3\", 0)", "anchorRadius": 0 }, { "value": 0, "link": "JavaScript:App.Drilldown.changes(1,\"10\/4\", 0)", "anchorRadius": 0 }, { "value": 0, "link": "JavaScript:App.Drilldown.changes(1,\"10\/5\", 0)", "anchorRadius": 0 }, { "value": 0, "link": "JavaScript:App.Drilldown.changes(1,\"10\/6\", 0)", "anchorRadius": 0 }] }]
                                };
                                App.Charts.action = new FusionCharts({
                                type: 'msline',
                                ...
                                App.Charts.action.exportChart({
                                exportFormat: 'csv',
                                        exportFileName: 'TestRail-actions-1-20221006134945'
                                });
                                });
                        ...
                        <div id="content_container">
                            ...
                            <div id="favs" class="hidden">
                                <div class="table summary summary-auto">
                                </div>
                            </div>

                            <h2 id="activeHeader" class="hidden">
                                Active </h2>
                            <div class="table summary summary-auto">
                                <div class="row project flex-projects-row" id="project-1">
                                    <div class="column summary-column summary-column-icon flex-projects-1 icon-project-64 ">
                                    </div>
                                    <div class="column summary-column flex-projects-2">
                                        <div class="summary-title text-ppp"
                                             style="position: relative; padding: 1px 0 1px 0">
                                            <span style="position: absolute; top: -1px">
                                                <a href="javascript:void(0)"
                                                   onclick="this.blur(); App.Projects.unstar(this, 1); return false;"
                                                   id="project-starred-1" class="starred link-tooltip"
                                                   tooltip-text="Remove from project favorites." style="display: none"></a>
                                                <a href="javascript:void(0)"
                                                   onclick="this.blur(); App.Projects.star(this, 1); return false;"
                                                   id="project-star-1" class="unstarred link-tooltip"
                                                   tooltip-text="Mark as project favorite."></a>
                                            </span>
                                            <a href="adminPJOverview.jsp" style="padding-left: 25px">aaaa</a>
                                            <span class="hidden fav-busy">
                                                <div class="icon-progress-inline"></div>
                                            </span>
                                        </div>
                                        <div class="summary-links text-secondary">
                                            <a class="link" href="adminTodo.jsp">Todos</a> |
                                            <a class="link" href="adminMilestone.jsp">Milestones</a> |
                                            <a class="link" href="adminTestRun.jsp">Test Runs</a> |
                                            <a class="link" href="adminTestCase.jsp">Test Cases</a> |
                                            <a class="link" href="adminReport.jsp">Reports</a>
                                        </div>
                                        <div class="summary-description">
                                            Contains <strong>0</strong> active test runs and
                                            <strong>0</strong> active milestones.
                                        </div>
                                        <div class="hidden details summary-expand">
                                        </div>
                                    </div>
                                    <div class="column summary-column summary-column-toggle flex-projects-3">
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div id="sidebar" class="column sidebar" style="width: 250px">
                    ...
                    <div class="sidebar-inner">
                        <a id="sidebar-projects-add" class="sidebar-button" href="addProject.jsp">
                            Add Project </a>
                        <p class="top"><strong class="text-softer">1</strong> active and <strong
                                class="text-softer">0</strong> completed projects.</p>
                    ...
                    <script type="text/javascript">
                        $(document).ready(function () {
                        jQuery("#trEnterpriseBanner").css('width', 'auto');
                        App.Hotkeys.register(
                                'p',
                                function () {
                                App.Page.load('admin/projects/add/1');
                                }
                        );
                        });
                    </script>
        ...
        <div id="userDropdown" class="dropdown dropdown-menu user-menu" rel="helpMenu" style="width: 125px">
            <ul>
                <li><a class="dropdown-menu-link" id="navigation-user-settings" href="mySettings.jsp">
                        My Settings</a></li>
                <li><a class="dropdown-menu-link" id="navigation-user-logout" href="logout">Logout</a></li>
            </ul>
        </div>
        ...
        <div class="dialog" id="dpaDialog" style="max-width: 725px">
            ...
            <div class="dialog-body">
                ...
                <form action="index.php?/admin/users/accept_data_processing_agreement" id="dpa_form" method="post"> <input
                        type="hidden" name="_token" value="EVjJWvyRW/qh6YmtD4SX" />
        ...
        <div class="dialog" id="trEnterpriseDialog" style="width: 350px; word-wrap: break-word">
            <div class="dialog-title"></div>
            <form action="index.php?/mysettings/tr_enterprise_banner_setting" id="tr_enterprise_form" method="post"> <input
                    type="hidden" name="_token" value="EVjJWvyRW/qh6YmtD4SX" />
                <div class="dialog-body">
                    <p style="margin: 0" class="dialog-message"></p>
                    <div class="form-group">
...
<!--        <div id="helpDropdown" class="dropdown dropdown-menu help-menu" rel="helpMenu" style="width: 175px">
            <ul>
                <li>
                    <a class="dropdown-menu-link" target="_blank"
                       href="https://www.gurock.com/testrail/docs/user-guide/getting-started">
                ...
                <li>
                    <a class="dropdown-menu-link" target="_blank"
                       href="https://www.gurock.com/testrail/docs/user-guide/howto/keyboard-shortcuts-hotkeys">
                ...
                <li class="dropdown-menu-separator"></li>
                <li>
                    <a class="dropdown-menu-link" href="javascript:void(0)"
                       onclick="this.blur(); App.Help.showAbout(); return false;">
        ...
        <div id="projectGoalHelp" class="tooltip tooltip-goal">
            ...
            <div class="tooltip-goal-body">
                <p class="top">Welcome! Start by creating your first project. Projects in Test Management System usually represent a
                    product or software project and serve as organizational unit for cases, results and milestones. You can
                    create as many projects as you like.</p>
        ...
        <div id="usersGoalHelp" class="tooltip tooltip-goal">
            ...
            <div class="tooltip-goal-body">
                <p class="top">Test Management System is especially useful when used with a team. Invite other team members and build your
                    test case repository, assign test runs and record results together. Easily track the workload and
                    progress from the Todo tab for your entire team.</p>
        ...
        <div id="integrationGoalHelp" class="tooltip tooltip-goal">
            ...
            <div class="tooltip-goal-body">
                <p class="top">Integrate Test management System with your issue/bug tracker (such as JIRA, Redmine &amp; more),
                    requirement tool and test automation. Start by configuring your issue integration to collaborate with
                    your dev team, run coverage reports and link issues to results.</p>
        ...
        <div id="goals" class="goals">
            <div id="goals-banner" class="goals-banner ">
                <span id="goals-cancel" class="goals-cancel hidden">
                    <a class="link-noline nolink" href="javascript:void(0)"
                       onclick="this.blur(); App.Users.hideGoals(false); return false;">
                ...
                <div class="goals-banner-inner">
                    <ol class="goals-progress">
                        <li class="goals-progress-step goals-progress-step-done">
                            ...
                            <div class="goals-progress-marker link-tooltip goal-project-checked"
                                 tooltip-id="#projectGoalHelp" tooltip-position="top" tooltip-width="400"></div>
                        </li>
                        <li class="goals-progress-step ">
                            <span class="goals-progress-title">Add cases</span>
                            <div class="goals-progress-marker link-tooltip goal-cases" tooltip-id="#casesGoalHelp"
                                 tooltip-position="top" tooltip-width="400"></div>
                        </li>
                        <li class="goals-progress-step ">
                            <span class="goals-progress-title">Start a run</span>
                            <div class="goals-progress-marker link-tooltip goal-run" tooltip-id="#runGoalHelp"
                                 tooltip-position="top" tooltip-width="400"></div>
                        </li>
                        <li class="goals-progress-step ">
                        ...
                        <li class="goals-progress-step ">
                            ...
                            <div class="goals-progress-marker link-tooltip goal-users" tooltip-id="#usersGoalHelp"
                                 tooltip-position="top" tooltip-width="400"></div>
                        </li>
                        <li class="goals-progress-step ">
                            <span class="goals-progress-title">Set up integration</span>
                            <div class="goals-progress-marker link-tooltip goal-integration"
                                 tooltip-id="#integrationGoalHelp" tooltip-position="top" tooltip-width="400"></div>
                        </li>
                    </ol>
                </div>
                ...
                <div id="goals-next" class="goals-next hidden">
                    <img src="https://static.testrail.io/7.5.4.2008/images/layout/blank.gif" usemap="#goalsNextMap"
                         class="goal-next" />
                    <map name="goalsNextMap">
                        <area shape="rect" coords="691,13,726,48" href="javascript:void(0)"
                              onclick="this.blur(); App.Users.hideGoalsNext(); return false;" />
                        <area shape="rect" coords="64,305,254,339" target="_blank"
                              href="http://www.gurock.com/testrail/support" />
                        ...
                        <area shape="rect" coords="496,305,686,339" target="_blank"
                              href="http://www.gurock.com/testrail/videos/introduction-projects/" />
                    </map>
                </div>
            </div>
        </div>
        ...
        <div id='newAttachmentTemplate' style='display: none;'>
            <div style='width: 150px; height: 150px; {{attachment_thumbnail}}'
                 class='attachment-block attachment-{{attachment_icon}} {{attachment_selected_class}} lazy'
                 id='libraryAttachment-{{attachment_id}}' onclick="App.Attachments.showInfoDialog('{{attachment_id}}');"
                ...
                <img {{attachment_src_tag}}='{{attachment_imgurl}}' {{attachment_onerror_tag}}='{{attachment_img_onerror}}'
                    class='hidden-image' />
                <div class='attachment-selection {{attachment_selected_class}}'
                     onclick="App.Attachments.toggleSelection('{{attachment_id}}', event);"></div>
            </div>
        </div>
        ...
        <script type="text/javascript" id="js-js-indicator"
        src="https://static.testrail.io/7.5.4.2008/js/indicator.js"></script>
        <script type="text/javascript" id="js-js-autocomplete"
        src="https://static.testrail.io/7.5.4.2008/js/autocomplete.js"></script>
        <script type="text/javascript">
            $(document).ready(function () {
