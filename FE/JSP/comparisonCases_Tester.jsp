<%-- 
    Document   : comparisonCases_Tester
    Created on : Nov 5, 2022, 1:07:36 PM
    Author     : phuon
--%>
                    ...
                    <div id="content-inner" class="content-inner goals-clear">
                        ...
                        <div class="report-box report-box-highlighted icon-form-32">
                            ...
                            <div class="report-box-intro">
                                ...
                                <p style="margin-bottom: 0">Shows the results for test cases in a coverage &amp; comparison matrix. Please see the Report Options section below to configure the report specific options.</p>
                            </div>
                        </div>
                        ...
                        <form action="index.php?/reports/add_job/1&amp;plugin=cases_result_coverage" method="post"><input type="hidden" name="_token" value="z51xCVlbXxse1qTvHf/r">
                            <div class="form-group form-group-main">
                                <label for="name">Name		<span class="form-required">*</span></label>
                                <input class="form-control " type="text" name="name" id="name" maxlength="250" value="Comparison for Cases (Results) %date%">
