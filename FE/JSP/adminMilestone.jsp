<%-- 
    Document   : adminMilestone
    Created on : Oct 25, 2022, 7:16:10 PM
    Author     : phuon
--%>
            ...
            <div id="body" class="table" style="display: table;">
                            ...
                            <div class="empty-content empty-info">	
                                ...
                                <div class="empty-body">
                                    ...
                                    <div class="button-group">
                                        <a href="addMilestone.jsp" class="button button-left button-add">
                                            Add Milestone					</a>
                                    </div>
                                </div>
                            </div>
                ...
                <div id="sidebar" class="column sidebar" style="width: 250px">
                    ...
                    <div class="sidebar-inner">
                        <a id="navigation-milestones-add" class="sidebar-button" href="addMilestone.jsp">
