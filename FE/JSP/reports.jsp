<%-- 
    Document   : reports
    Created on : Oct 25, 2022, 9:08:04 PM
    Author     : phuon
--%>
                    ...
                    <div id="content-inner" class="content-inner goals-clear">
                        ...
                        <div class="empty empty-with-explanation" style="margin-bottom: 2em">
                            <div class="empty-explanation">
                                <div class="empty-explanation-title">What's a report?</div>
                                <div class="empty-explanation-body">A report lets you generate statistics and charts for the data in your Test Management System installation.</div>
                            </div>
                            <div class="empty-content empty-info">
                                <div class="empty-title">This project doesn't contain any reports, yet.</div>
                                <div class="empty-body">
                                    <p>No reports have been added to this project yet. You can create or schedule reports for the report templates in the sidebar.</p>
                                </div>
                            </div>
                        </div>	
                        ...
                        <div class="dialog" id="shareReportDialog" style="width: 500px">
                            <div class="dialog-title">Share Report</div>
                            <form id="shareReportForm" action="post">
                                <div class="dialog-body">
                                    <div class="message message-error validationError" id="shareReportErrors" style="white-space: pre-line"></div>
                                    <div class="message message-success successPanel" id="shareReportSuccess" style="display: none">Successfully shared the report via email.</div>
                                    <p class="" style="margin-top: 0">You can share this report with other users or external people (with no Test Management System access). <br>For larger reports which may not display correctly in a PDF, you have the option of using HTML format instead,<br> but please note that some email providers will block HTML reports from being sent. <br>As an alternative, please consider splitting the report scope into multiple, smaller, PDF reports.</p>
                                    <div id="shareReportLinkContainer" class="form-group">
                                        <div class="checkbox" style="margin-left: 5px; margin-bottom: 8px">
                                            <label>
                                                Email a link to the report (requires Test Management System access):						<input type="checkbox" id="shareReportLink" name="shareReportLink" value="1">
                                            </label>
                                        </div>
                                        <div style="margin-left: 25px">
                                            <select id="shareReportLinkRecipients" name="shareReportLinkRecipients" class="form-control form-select" style="height: 100px; width: 447px" multiple="multiple">
                                    ...
                                    <div id="shareReportAttachmentContainer">
                                        <input type="hidden" id="shareReportAttachment" name="shareReportAttachment" value="0">
                                        <div class="checkbox" style="margin-left: 5px; margin-bottom: 8px">
                                            <label>
                                                Email the report as HTML attachment                        <input type="checkbox" id="shareReportHTMLAttachment" name="shareReportHTMLAttachment" value="1">
                                            </label>
                                        </div>
                                        <div class="checkbox" style="margin-left: 5px; margin-bottom: 8px">
                                            <label>
                                                Email the report as PDF attachment                        <input type="checkbox" id="shareReportPDFAttachment" name="shareReportPDFAttachment" value="1">
                                            </label>
                                        </div>
                                        <div style="margin-left: 25px">
                                            <textarea id="shareReportAttachmentRecipients" name="shareReportAttachmentRecipients" class="form-control processed" style="height: 100px; width: 435px">person1@example.com
person2@example.com</textarea>
                                ...
                                <div class="button-group dialog-buttons-highlighted">
                                    <button class="button button-left button-positive button-ok dialog-action-default" id="shareReportSubmit" type="submit">
                                        Share			</button>
                ...
                <div id="sidebar" class="column sidebar" style="width: 250px">
                    <div class="dialog bulk-delete-dialog" id="bulkDeleteDialog">
                        ...
                        <div class="dialog-body">
                            <p class="top bottom dialog-message"><strong>Delete all selected reports?</strong> This action cannnot be <br>undone.</p>
                            <p class="dialog-extra text-delete"></p>
                            <div class="message message-delete bottom delete-confirm-container confirm-container">
                                <div class="checkbox">
                                    <label>
                                        <span class="dialog-confirm"><span style="color:red">Yes, delete all selected Reports (cannot be undone)</span></span>
