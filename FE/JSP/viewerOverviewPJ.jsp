<%-- 
    Document   : viewerOverviewPJ
    Created on : Oct 26, 2022, 8:30:04 AM
    Author     : phuon
--%>
    ...
    <body style="min-width: 960px" class="modern">
        ...
        <div id="top">
            ...
            <div class="top-section top-section-with-return text-ppp">
                <span id="return"><a
                        ...
                        href="viewerDashboard.jsp">&larr; Return to Dashboard</a></span>
                <a class="link-noline" id="navigation-project"
                   href="viewerOverviewPJ.jsp">aaaa</a>
            </div>
        </div>
        ...
        <div id="header">
            <ul class="header-menu">
                <li class="header-menu-item header-menu-item-selected"><a tabindex="-1" href="viewerOverviewPJ.jsp" id="navigation-projects">Overview</a></li><li class="header-menu-item"><a tabindex="-1" href="#" id="navigation-todos">Todo</a></li><li class="header-menu-item"><a tabindex="-1" href="#" id="navigation-milestones">Milestones</a></li><li class="header-menu-item"><a tabindex="-1" href="#" id="navigation-runs">Test Runs &amp; Results</a></li>
                <li class="header-menu-item"><a tabindex="-1" href="#" id="navigation-suites">Test Cases</a></li>
                <li class="header-menu-item"><a tabindex="-1" href="#" id="navigation-reports">Reports</a></li>	</ul>
        </div>
                        ...
                        <div id="content_container">
                            <div class="table">
                                <div class="column column-p2 column-pad-right">
                                    <h1 class="top"><a id="navigation-overview-viewmilestones" class="nolink" href="#">Milestones</a></h1>
                                ...
                                <div class="column column-p2 column-pad-left">
                                    <h1 class="top"><a id="navigation-overview-runs" class="nolink" href="#">Test Runs</a></h1>
                                    <p>This project doesn't have any active milestones. Unfortunately, you don't have the permissions to add one.</p>
