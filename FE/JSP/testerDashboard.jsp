<%-- 
    Document   : testerDashboard
    Created on : Oct 23, 2022, 6:16:28 PM
    Author     : phuon
--%>
    ...
    <body>
        ...
        <div id="header">
            <ul class="header-menu">
                ...
                <li class="header-menu-item header-menu-item-selected"><a tabindex="-1" href="testerDashboard.jsp"
                                            ...
                                            <div class="table chart-legend-item">
                                                ...
                                                <div class="column">
                                                    <div class="chart-legend-name text-ppp"><a
                                                            href="testerOverviewPJ.jsp">aaaa</a></div>
                                ...
                                <div class="row project flex-projects-row" id="project-1">
                                    ...
                                    <div class="column summary-column flex-projects-2">
                                        <div class="summary-title text-ppp"
                                            ...
                                            <a href="testerOverviewPJ.jsp" style="padding-left: 25px">aaaa</a>
                                            <span class="hidden fav-busy">
                                                <div class="icon-progress-inline"></div>
                                            </span>
                                        </div>
                                        <div class="summary-links text-secondary">
                                            <a class="link" href="todos.jsp">Todos</a> |
                                            <a class="link" href="milestones.jsp">Milestones</a> |
                                            <a class="link" href="testerTestRun.jsp">Test Runs</a> |
                                            <a class="link" href="testcases.jsp">Test Cases</a> |
                                            <a class="link" href="reports.jsp">Reports</a>
                                        </div>
        ...
        <div id="userDropdown" class="dropdown dropdown-menu user-menu" rel="helpMenu" style="width: 125px">
            <ul>
                <li><a class="dropdown-menu-link" id="navigation-user-settings" href="index.php?/mysettings">
                        My Settings</a></li>
