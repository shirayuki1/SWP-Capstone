<%-- 
    Document   : summaryPlan
    Created on : Nov 3, 2022, 11:01:27 AM
    Author     : phuon
--%>
                            ...
                            <table class="grid create-report">
                                ...
                                <tbody><tr class="dark">
                                        <td class="dark text-softer ">
                                            <a class="link-noline link-tooltip" href="activitySumary.jsp" tooltip-text="Shows a summary oindex.php?/reports/add_job/1&amp;plugin=cases_activity_summaryf new and updated test cases." tooltip-position="left">
                                                Activity Summary</a>
                                        </td>
