<%-- 
    Document   : sumPlan
    Created on : Nov 5, 2022, 1:08:57 PM
    Author     : phuon
--%>
                    ...
                    <div id="content-inner" class="content-inner goals-clear">
                        ...
                        <div class="report-box report-box-highlighted icon-form-32">
                            ...
                            <div class="report-box-intro">
                                ...
                                <p style="margin-bottom: 0">Shows a summary and overview for a test plan. Please see the Report Options section below to configure the report specific options.</p>
                            </div>
                        </div>
                        ...
                        <form action="index.php?/reports/add_job/1&amp;plugin=plans_summary" method="post"><input type="hidden" name="_token" value="z51xCVlbXxse1qTvHf/r">
                            <div class="form-group form-group-main">
                                <label for="name">Name		<span class="form-required">*</span></label>
                                <input class="form-control " type="text" name="name" id="name" maxlength="250" value="Plan (Summary) %date%">
                            ...
                            <div class="report-form">
                                ...
                                <div class="tabs">
                                    <div class="tab-header">
                                        <a href="javascript:void(0)" class="tab1 current" rel="1" onclick="App.Tabs.activate(this)">Test Plan &amp; Details</a>
                                    ...
                                    <div class="tab-body tab-frame">
                                        <div class="tab tab1 ">
                                            ...
                                            <p class="top">Use the following test plan:	<span class="form-required">*</span></p>
                                            <div style="margin-left: 15px">
                                                <select class="form-control form-select " id="custom_plans_id" name="custom_plans_id" style="width: 450px">
                                                    <option value=""></option>
                                                </select>
                                            </div>
                            ...
                            <table class="grid create-report">
                                ...
                                <tbody><tr class="dark">
                                        <td class="dark text-softer ">
                                            <a class="link-noline link-tooltip" href="activitySummary_Tester.jsp" tooltip-text="Shows a summary oindex.php?/reports/add_job/1&amp;plugin=cases_activity_summaryf new and updated test cases." tooltip-position="left">
                                                Activity Summary</a>
                                        </td>
