<%-- 
    Document   : propDistribution_Tester
    Created on : Nov 5, 2022, 1:05:44 PM
    Author     : phuon
--%>
                    ...
                    <div id="content-inner" class="content-inner goals-clear">
                        ...
                        <div class="report-box report-box-highlighted icon-form-32">
                            ...
                            <div class="report-box-intro">
                                ...
                                <p style="margin-bottom: 0">Shows a summary of test cases, grouped by a selectable attribute. Please see the Report Options section below to configure the report specific options.</p>
                            </div>
                        </div>
                        ...
                        <form action="index.php?/reports/add_job/1&amp;plugin=cases_property_groups" method="post"><input type="hidden" name="_token" value="5cMtXCbRHk4p2BzVekok">
                            <div class="form-group form-group-main">
                                <label for="name">Name		<span class="form-required">*</span></label>
                                <input class="form-control " type="text" name="name" id="name" maxlength="250" value="Property Distribution (Cases) %date%">
                                ...
                                <div class="tabs">
                                    ...
                                    <div class="tab-body tab-frame">
                                        <div class="tab tab1 ">
                                            ...
                                            <p class="top">Group the test cases by:</p>
                                            <div style="margin-left: 15px">
                                                <select class="form-control form-select " id="custom_cases_groupby" name="custom_cases_groupby" style="width: 200px">
                                                    ...
                                                    <option value="cases:created_by">
                                                        Created By		</option>
                                                    <option value="cases:priority_id" selected="selected">
                                                        Priority		</option>
                                            ...
                                            <div class="checkbox form-checkbox" style="margin-left: 15px">
                                                <label>
                                                    An aggregated summary of groups					<input type="checkbox" id="custom_cases_include_summary" name="custom_cases_include_summary" value="1" checked="checked">
                                                </label>
                                            </div>
                                            <div class="checkbox" style="margin-left: 15px">
                                                <label>
                                                    The test case details per group					<input type="checkbox" id="custom_cases_include_details" name="custom_cases_include_details" value="1" checked="checked">
                                                </label>
                                            </div>
                                        </div>
                                        ...
                                        <div class="tab tab3 hidden">
                                            ...
                                            <p class="">Maximum number of test cases to display (per group):</p>
                                            <div style="margin-left: 15px">
