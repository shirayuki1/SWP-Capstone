<%-- 
    Document   : sumRun
    Created on : Nov 5, 2022, 1:09:19 PM
    Author     : phuon
--%>
    ...
    <body style="min-width: 960px" class="modern">
            ...
            <div class="top-panel">
                <div class="top-panel-inner">
                    ...
                    <div class="top-search">
                        <form action="index.php?/search/index/1" style="display: inline" method="post">					<input type="hidden" name="_token" value="z51xCVlbXxse1qTvHf/r">					<input class="top-search-control" type="text" name="query" tabindex="-1">
                        </form>			</div>
                </div>
            </div>
        ...
        <div id="header">
            <ul class="header-menu">
                ...
                <li class="header-menu-item header-menu-item-selected"><a tabindex="-1" href="reports.jsp" id="navigation-reports">Reports</a></li>	</ul>
        </div>
                    ...
                    <div id="content-inner" class="content-inner goals-clear">
                        ...
                        <div class="report-box report-box-highlighted icon-form-32">
                            ...
                            <div class="report-box-intro">
                                ...
                                <p style="margin-bottom: 0">Shows a summary and overview for one or multiple test runs. Please see the Report Options section below to configure the report specific options.</p>
                            </div>
                        </div>
                        ...
                        <form action="index.php?/reports/add_job/1&amp;plugin=runs_summary" method="post"><input type="hidden" name="_token" value="z51xCVlbXxse1qTvHf/r">
                            <div class="form-group form-group-main">
                                <label for="name">Name		<span class="form-required">*</span></label>
                                <input class="form-control " type="text" name="name" id="name" maxlength="250" value="Runs (Summary) %date%">
                                ...
                                <div class="tabs">
                                    <div class="tab-header">
                                        <a href="javascript:void(0)" class="tab1 current" rel="1" onclick="App.Tabs.activate(this)">
                                            Test Runs					</a>
                                        <a href="javascript:void(0)" class="tab2 " rel="2" onclick="App.Tabs.activate(this)">Details</a>
                                        <a href="javascript:void(0)" class="tab3 " rel="3" onclick="App.Tabs.activate(this)">Activity</a>
                                        <a href="javascript:void(0)" class="tab4 " rel="4" onclick="App.Tabs.activate(this)">Tests</a>
                                    </div>
                                    <div class="tab-body tab-frame">
                                        <div class="tab tab1 ">
                                            ...
                                            <input type="hidden" name="custom_runs_sections_include" value="1">

                                            <input type="hidden" name="custom_runs_suites_include" value="1">



                                            <p class="top">Include the test results of:</p>
                                            <div class="radio form-radio" style="margin-left: 15px">
                                                <label>
                                                    The test runs that match the following filter (now and in the future):		<input type="radio" id="custom_runs_include_filter" name="custom_runs_include" value="2">
                                                </label>
                                            </div>
                                            <div class="form-radio" style="margin-left: 35px">
                                                <div class="form-message filter-info">
                                                    <span id="custom_runs_filter_info">
                                                        ...
                                                        [No filter set]			</span>
                                                    (<a id="custom_runs_filter_change" href="javascript:void(0)">change</a>)
                                                    <span id="custom_runs_filter_busy" class="busy">
                                            ...
                                            <div class="radio form-radio" style="margin-left: 15px">
                                                <label>
                                                    Only the following test runs:		<input type="radio" id="custom_runs_include_selected" name="custom_runs_include" value="3">
                                                </label>
                                            </div>
                                            <div style="margin-left: 35px">
                                                <div class="grid-container" style="margin-bottom: 5px">
                                                    <table id="custom_runs_grid" class="grid">
                                                        <colgroup>
                                                            <col>
                                                            <col style="width: 25%">
                                                            <col style="width: 25%">
                                                ...
                                                <div style="margin-top: 1em">
                                                    <a id="custom_runs_add" href="javascript:void(0)">
                                                        Add Test Runs</a>
                                                </div>
                                            </div>

                                            <input type="hidden" name="custom_runs_filters" id="custom_runs_filters" value="">
                                            <input type="hidden" name="custom_runs_ids" id="custom_runs_ids" value="">

                                            <script type="text/javascript">
                                                $(document).ready(function()
                                                {
                                                App.ReportPlugins.Runs.Select.namespace = 'custom_runs';
                                                App.ReportPlugins.Runs.Select.project_id = 1;
                                                App.ReportPlugins.Runs.Select.multiple_suites = true;
                                                App.ReportPlugins.Runs.Select.suite_ids = [1];
                                                App.ReportPlugins.Runs.Select.lang = {
                                                'add_empty': 'You need to select a test suite before you can add test runs.'	};
                                                App.ReportPlugins.Runs.Select.init();
                                                $('form').submit(
                                                        function()
                                                        {
                                                        var ids = '';
                                                        if (App.ReportPlugins.Runs.Select.run_ids)
                                                        {
                                                        ids = App.ReportPlugins.Runs.Select.run_ids.join(',');
                                                        }

                                                        $('#custom_runs_ids').val(ids);
                                                        var filters = '';
                                                        if (App.ReportPlugins.Runs.Select.filters)
                                                        {
                                                        filters = JSON.stringify(App.ReportPlugins.Runs.Select.filters);
                                                        }

                                                        $('#custom_runs_filters').val(filters);
                                                        }
                                                );
                                                });
                                            </script>
                                            ...
                                            <p class="">Maximum number of test runs to include (latest first):</p>
                                            <div style="margin-left: 15px">
                                                <select class="form-control form-select " id="custom_runs_limit" name="custom_runs_limit" style="width: 200px">
                                                    <option value="5">
                                                        5			</option>
                                                    <option value="10">
                                                        10			</option>
                                        ...
                                        <div class="tab tab2 hidden">
                                            <p class="top">Include the following details/sections:</p>
                                            <div class="checkbox form-checkbox" style="margin-left: 15px">
                                                <label>
                                                    Status and test statistics					<input type="checkbox" id="custom_status_include" name="custom_status_include" value="1" checked="checked">
                                                </label>
                                            </div>
                                            <div class="checkbox form-checkbox" style="margin-left: 15px">
                                                <label>
                                                    Activity (results over time)					<input type="checkbox" id="custom_activities_include" name="custom_activities_include" value="1" checked="checked">
                                                </label>
                                            </div>
                                            <div class="checkbox form-checkbox" style="margin-left: 15px">
                                                <label>
                                                    Progress and remaining estimate/forecast					<input type="checkbox" id="custom_progress_include" name="custom_progress_include" value="1" checked="checked">
                                                </label>
                                            </div>
                                            <div class="checkbox" style="margin-left: 15px; padding-bottom: 0">
                                                <label>
                                                    Tests and test results					<input type="checkbox" id="custom_tests_include" name="custom_tests_include" value="1" checked="checked">
                                                </label>
                                            </div>
                                        </div>
                                        <div class="tab tab3 hidden">
                                            ...
                                            <p class="top">Use the following time frame:	<span class="form-required">*</span></p>
                                            <div style="margin-left: 15px">
                                                <select class="form-control form-select " id="custom_activities_daterange" name="custom_activities_daterange" style="width: 200px">
                                            ...
                                            <div style="margin-left: 15px; margin-top: 8px" id="custom_activities_daterange_from_container" class="hidden">
                                                <div style="float: left; line-height: 150%">
                                                    From:	</div>
                                                <div style="margin-left: 50px">
                                                    <input class="form-control datepicker hasDatepicker" type="text" style="width: 125px" name="custom_activities_daterange_from" id="custom_activities_daterange_from" value="">
                                                </div>
                                                <div style="clear: both"></div>
                                            </div>
                                            <div style="margin-left: 15px; margin-top: 8px" id="custom_activities_daterange_to_container" class="hidden">
                                                <div style="float: left; line-height: 150%">
                                                    To:<br>
                                                </div>
                                                <div style="margin-left: 50px">
                                                    <input class="form-control datepicker hasDatepicker" type="text" style="width: 125px" name="custom_activities_daterange_to" id="custom_activities_daterange_to" value="">
                                                </div>
                                                <div style="clear: both"></div>
                                            </div>
                                            ...
                                            <script type="text/javascript">
                                                $(document).ready(
                                                        function()
                                                        {
                                                        $('#custom_activities_daterange').change(
                                                                function()
                                                                {
                                                                var type_id = $(this).val();
                                                                if (type_id == 2)
                                                                {
                                                                $('#custom_activities_daterange_from_container').show();
                                                                $('#custom_activities_daterange_to_container').show();
                                                                }
                                                                else
                                                                {
                                                                $('#custom_activities_daterange_from').val('');
                                                                $('#custom_activities_daterange_from_container').hide();
                                                                $('#custom_activities_daterange_to').val('');
                                                                $('#custom_activities_daterange_to_container').hide();
                                                                }
                                                                }
                                                        );
                                                        App.applyDatepicker(
                                                                $('#custom_activities_daterange_from_container')
                                                                );
                                                        App.applyDatepicker(
                                                                $('#custom_activities_daterange_to_container')
                                                                );
                                                        }
                                                );
                                            </script>
                                            ...
                                            <p class="">Include the following statuses:</p>
                                            <div class="radio form-radio" style="margin-left: 15px">
                                                <label>
                                                    All statuses		<input type="radio" id="custom_activities_statuses_include_all" name="custom_activities_statuses_include" value="1" checked="checked">
                                                </label>
                                            </div>
                                            <div class="radio form-radio" style="margin-left: 15px">
                                                <label>
                                                    The following statuses only:		<input type="radio" id="custom_activities_statuses_include_selected" name="custom_activities_statuses_include" value="2">
                                                </label>
                                            </div>
                                            <div style="margin-left: 35px">
                                                <select class="form-control form-select " id="custom_activities_statuses_ids" name="custom_activities_statuses_ids[]" style="width: 100%; height: 200px" multiple="multiple">
                                                ...
                                                <div class="form-description">You can select multiple statuses by holding Ctrl/Cmd on your keyboard.</div>
                                            </div>



                                            <p class="">Maximum number of activities to display:</p>
                                            <div style="margin-left: 15px">
                                                <select class="form-control form-select " id="custom_activities_limit" name="custom_activities_limit" style="width: 200px">
                                                    <option value="10">
                                                        10			</option>
                                                    <option value="25">
                                                        25			</option>
                                        ...
                                        <div class="tab tab4 hidden">
                                            ...
                                            <p class="top">Apply the following filter for the tests:</p>
                                            <div style="margin-left: 15px">
                                                <div class="form-message filter-info">
                                                    <span id="custom_tests_filter_info">
                                                        ...
                                                        [No filter set]			</span>
                                                    (<a id="custom_tests_filter_change" href="javascript:void(0)">change</a>)
                                                    <span id="custom_tests_filter_busy" class="busy">
                                                        <div class="icon-progress-inline"></div>
                                                    </span>
                                                </div>
                                            </div>

                                            <input type="hidden" name="custom_tests_filters" id="custom_tests_filters" value="">

                                            <script type="text/javascript">
                                                $(document).ready(function()
                                                {
                                                App.ReportPlugins.Tests.Filter.namespace = 'custom_tests';
                                                App.ReportPlugins.Tests.Filter.project_id = 1;
                                                App.ReportPlugins.Tests.Filter.init();
                                                $('form').submit(
                                                        function()
                                                        {
                                                        var filters = '';
                                                        if (App.ReportPlugins.Tests.Filter.filters)
                                                        {
                                                        filters = JSON.stringify(App.ReportPlugins.Tests.Filter.filters);
                                                        }

                                                        $('#custom_tests_filters').val(filters);
                                                        }
                                                );
                                                });
                                            </script>
                                            ...
                                            <div style="margin-left: 15px">
                                                <div class="grid-container" style="margin-bottom: 5px">
                                                    <table id="custom_tests_grid" class="grid">
                                                        <colgroup>
                                                            <col class="drag-no">
                                                            <col>
                                                            <col class="input">
                                                        ...
                                                        <tbody><tr class="header droppable">
                                                            ...
                                                            <tr id="column-tests:id" class="row droppable odd" rel="tests:id">
                                                                ...
                                                                <td></td>
                                                                <td><a tabindex="-1" href="javascript:void(0)" onclick="this.blur(); App.ReportPlugins.Columns.Select.remove('tests:id'); return false;"><div class="icon-small-delete"></div></a></td>
                                                            </tr>
                                                ...
                                                <div style="margin-top: 1em">
                                                    <a id="custom_tests_add" href="javascript:void(0)">Add Column</a>
                                                </div>
                                            </div>

                                            <input type="hidden" name="custom_tests_columns" id="custom_tests_columns" value="">

                                            <script type="text/javascript">
                                                $(document).ready(function()
                                                {
                                                App.ReportPlugins.Columns.Select.namespace = 'custom_tests';
                                                App.ReportPlugins.Columns.Select.columns = {};
                                                App.ReportPlugins.Columns.Select.columns['tests:assignedto_id'] = 'Assigned To';
                                                App.ReportPlugins.Columns.Select.columns['cases:custom_automation_type'] = 'Automation Type';
                                                App.ReportPlugins.Columns.Select.columns['tests:original_case_id'] = 'Case ID';
                                                App.ReportPlugins.Columns.Select.columns['tests:defects'] = 'Defects';
                                                App.ReportPlugins.Columns.Select.columns['tests:defects_all'] = 'Defects All';
                                                App.ReportPlugins.Columns.Select.columns['tests:elapsed'] = 'Elapsed';
                                                App.ReportPlugins.Columns.Select.columns['tests:elapsed_all'] = 'Elapsed All';
                                                ...
                                                App.ReportPlugins.Columns.Select.columns['tests:id'] = 'ID';
                                                App.ReportPlugins.Columns.Select.columns['tests:in_progress_by'] = 'In Progress';
                                                ...
                                                App.ReportPlugins.Columns.Select.columns['tests:status_id'] = 'Status';
                                                App.ReportPlugins.Columns.Select.columns['cases:template_id'] = 'Template';
                                                App.ReportPlugins.Columns.Select.columns['tests:tested_by'] = 'Tested By';
                                                App.ReportPlugins.Columns.Select.columns['tests:tested_on'] = 'Tested On';
                                                App.ReportPlugins.Columns.Select.columns['cases:title'] = 'Title';
                                                App.ReportPlugins.Columns.Select.columns['cases:type_id'] = 'Type';
                                                App.ReportPlugins.Columns.Select.columns['tests:version'] = 'Version';
                                                App.ReportPlugins.Columns.Select.columns['tests:version_all'] = 'Version All';
                                                App.ReportPlugins.Columns.Select.init();
                                                $('form').submit(function()
                                                {
                                                var columns = {};
                                                $('#custom_tests_grid tr.row').each(
                                                        function(ix, v)
                                                        {
                                                        var row = $(v);
                                                ...
                                                $('#custom_tests_columns').val(JSON.stringify(columns));
                                                });
                                                });
                                            </script>
                                            ...
                                            <p class="">Maximum number of tests to display:</p>
                                            <div style="margin-left: 15px">
                                                <select class="form-control form-select " id="custom_tests_limit" name="custom_tests_limit" style="width: 200px">
                                                    <option value="10">
                                                        10			</option>
                                                    <option value="25">
                                                        25			</option>
                            ...
                            <div class="report-box report-box-stacked icon-schedule-32 ">
                                ...
                                <div class="report-box-controls">
                                    ...
                                    <div style="margin-left: 35px">
                                        ...
                                        Until : 			<a href="javascript:void(0);" class="disabled" id="schedule_until_link">
                                            Select a date			</a>
                            ...
                            <div class="report-box report-box-stacked report-box-stacked-last icon-notification-32">
                                ...
                                <div class="report-box-controls">
                                    ...
                                    <div id="notifyLinkContainer" class="form-group">
                                        ...
                                        <div style="margin-left: 35px">
                                            <select id="notify_link_recipients_select" class="form-control form-select " style="height: 100px; width: 447px" disabled="disabled" multiple="multiple">
                                                <option value="1">Doan Khoa Bao</option>
...
person2@example.com</textarea>
                            ...
                            <div class="button-group form-buttons">
                                <button class="button button-left button-positive button-ok" id="submit" type="submit">
                                    Add Report	</button>
                                <a href="index.php?/reports/overview/1" class="button button-left button-negative button-cancel">
                                    Cancel	</a>
                            </div>
                                ...
                                <div class="dialog-body">
                                    <div class="form-group bottom">
                                        ...
                                        <select class="form-control form-control-full form-select" name="addColumnItems" id="addColumnItems">
                                            <option id="addColumn-tests:assignedto_id" value="tests:assignedto_id">
                                                Assigned To					</option>
                                            <option id="addColumn-cases:custom_automation_type" value="cases:custom_automation_type">
                                                Automation Type					</option>
                                            <option id="addColumn-tests:original_case_id" value="tests:original_case_id">
                                                Case ID					</option>
                                            <option id="addColumn-tests:defects" value="tests:defects">
                                                Defects					</option>
                                            <option id="addColumn-tests:defects_all" value="tests:defects_all">
                                                Defects All					</option>
                                            <option id="addColumn-tests:elapsed" value="tests:elapsed">
                                                Elapsed					</option>
                                            <option id="addColumn-tests:elapsed_all" value="tests:elapsed_all">
                                                Elapsed All					</option>
                                            ...
                                            <option id="addColumn-cases:estimate_forecast" value="cases:estimate_forecast">
                                                Forecast					</option>
                                            <option id="addColumn-tests:in_progress_by" value="tests:in_progress_by">
                                                In Progress					</option>
                                            ...
                                            <option id="addColumn-cases:section_id" value="cases:section_id">
                                                Section					</option>
                                            <option id="addColumn-tests:status_id" value="tests:status_id">
                                                Status					</option>
                                            <option id="addColumn-cases:template_id" value="cases:template_id">
                                                Template					</option>
                                            <option id="addColumn-tests:tested_by" value="tests:tested_by">
                                                Tested By					</option>
                                            <option id="addColumn-tests:tested_on" value="tests:tested_on">
                                                Tested On					</option>
                                            <option id="addColumn-cases:type_id" value="cases:type_id">
                                                Type					</option>
                                            <option id="addColumn-tests:version" value="tests:version">
                                                Version					</option>
                                            <option id="addColumn-tests:version_all" value="tests:version_all">
                                                Version All					</option>
                                        </select>
                        ...
                        <div class="dialog" id="addRunsDialog" style="width: 850px; height: 700px">
                            <div class="dialog-title">Add Test Runs</div>
                            <form id="addRunsForm">
                                <div class="dialog-body" style="padding: 0">
                                    <div id="addRunsContainer" class="select-dialog-container">							
                                        <div id="addRunsContent" class="select-dialog-content hidden">
                                        </div>
                                        <div id="addRunsProgress" class="select-dialog-progress" style="margin: auto">
                            ...
                            <div class="dialog-buttons-pane-container">
                                <div class="button-group dialog-buttons-highlighted">
                                    <button type="submit" id="addRunsSubmit" class="button button-left button-positive button-ok dialog-action-default"> 
                                        OK			</button>
                                    <a id="addRunsClose" class="button button-left button-negative button-cancel dialog-action-close">
                                        Cancel			</a>
                                </div>
                            </div>
                        </div>

                        <div class="bubble filter-bubble hidden" id="filterRunsBubble">
                            <div id="filterRunsContent" class="filter-bubble-inner">
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="sidebar-inner">
                            ...
                            <table class="grid create-report">
                                ...
                                <tbody><tr class="dark">
                                        <td class="dark text-softer ">
                                            <a class="link-noline link-tooltip" href="activitySummary_Tester.jsp" tooltip-text="Shows a summary of new and updated test cases." tooltip-position="left">
                                                Activity Summary</a>
                                        </td>
                                        <td class="dark action-large ">
                                            <a href="activitySummary_Tester.jsp">
                                    ...
                                    <tr class="dark">
                                        <td class="dark text-softer ">
                                            <a class="link-noline link-tooltip" href="coverageRef_Tester.jsp" tooltip-text="Shows the test case coverage for references in a coverage matrix." tooltip-position="left">
                                                Coverage for References</a>
                                        </td>
                                        <td class="dark action-large ">
                                            <a href="coverageRef_Tester.jsp">
                                                <div class="icon-add"></div>
                                            </a>
                                        </td>
                                    </tr>
                                    <tr class="dark">
                                        <td class="dark text-softer ">
                                            <a class="link-noline link-tooltip" href="propDistribution_Tester.jsp" tooltip-text="Shows the test cases grouped by a selectable attribute." tooltip-position="left">
                                                Property Distribution</a>
                                        </td>
                                        <td class="dark action-large ">
                                            <a href="propDistribution_Tester.jsp">
                                                <div class="icon-add"></div>
                                            </a>
                                        </td>
                                    </tr>
                                    <tr class="dark">
                                        <td class="dark text-softer ">
                                            <a class="link-noline link-tooltip" href="statusTops_Tester.jsp" tooltip-text="Shows the test cases with the highest amount of results, grouped by status." tooltip-position="left">
                                                Status Tops</a>
                                        </td>
                                        <td class="dark action-large ">
                                            <a href="statusTops_Tester.jsp">
                                                <div class="icon-add"></div>
                                            </a>
                                        </td>
                                    </tr>
                        ...
                        <div style="margin-left: 10px">
                            <table class="grid create-report">
                                ...
                                <tbody><tr class="dark">
                                        <td class="dark text-softer ">
                                            <a class="link-noline link-tooltip" href="defSummary_Tester.jsp" tooltip-text="Shows the found defects for a milestone, test plan or select test runs." tooltip-position="left">
                                                Summary</a>
                                        </td>
                                        <td class="dark action-large ">
                                            <a href="defSummary_Tester.jsp">
                                                <div class="icon-add"></div>
                                            </a>
                                        </td>
                                    </tr>
                                    <tr class="dark">
                                        <td class="dark text-softer ">
                                            <a class="link-noline link-tooltip" href="sumCases_Tester.jsp" tooltip-text="Shows the found defects for test cases in a coverage matrix." tooltip-position="left">
                                                Summary for Cases</a>
                                        </td>
                                        <td class="dark action-large ">
                                            <a href="sumCases_Tester.jsp">
                                                <div class="icon-add"></div>
                                            </a>
                                        </td>
                                    </tr>
                                    <tr class="dark">
                                        <td class="dark text-softer ">
                                            <a class="link-noline link-tooltip" href="sumReferences_Tester.jsp" tooltip-text="Shows the found defects for references in a coverage matrix." tooltip-position="left">
                                                Summary for References</a>
                                        </td>
                                        <td class="dark action-large ">
                                            <a href="sumReferences_Tester.jsp">
                                                <div class="icon-add"></div>
                                            </a>
                                        </td>
                                    </tr>
                        ...
                        <div style="margin-left: 10px">
                            <table class="grid create-report">
                                ...
                                <tbody><tr class="dark">
                                        <td class="dark text-softer ">
                                            <a class="link-noline link-tooltip" href="comparisonCases_Tester.jsp" tooltip-text="Shows the results for test cases in a coverage &amp; comparison matrix." tooltip-position="left">
                                                Comparison for Cases</a>
                                        </td>
                                        <td class="dark action-large ">
                                            <a href="comparisonCases_Tester.jsp">
                                                <div class="icon-add"></div>
                                            </a>
                                        </td>
                                    </tr>
                                    <tr class="dark">
                                        <td class="dark text-softer ">
                                            <a class="link-noline link-tooltip" href="comparisonReferences_Tester.jsp" tooltip-text="Shows the results for references in a coverage &amp; comparison matrix." tooltip-position="left">
                                                Comparison for References</a>
                                        </td>
                                        <td class="dark action-large ">
                                            <a href="comparisonReferences_Tester.jsp">
                                                <div class="icon-add"></div>
                                            </a>
                                        </td>
                                    </tr>
                                    <tr class="dark">
                                        <td class="dark text-softer ">
                                            <a class="link-noline link-tooltip" href="resultPropDistribution_Tester.jsp" tooltip-text="Shows the tests grouped by a selectable attribute." tooltip-position="left">
                                                Property Distribution</a>
                                        </td>
                                        <td class="dark action-large ">
                                            <a href="resultPropDistribution_Tester.jsp">
                                                <div class="icon-add"></div>
                                            </a>
                                        </td>
                                    </tr>
                        ...
                        <div style="margin-left: 10px">
                            <table class="grid create-report">
                                ...
                                <tbody><tr class="dark">
                                        <td class="dark text-softer ">
                                            <a class="link-noline link-tooltip" href="sumMilestone_Tester.jsp" tooltip-text="Shows a status summary for a milestone." tooltip-position="left">
                                                Milestone</a>
                                        </td>
                                        <td class="dark action-large ">
                                            <a href="sumMilestone_Tester.jsp">
                                                <div class="icon-add"></div>
                                            </a>
                                        </td>
                                    </tr>
                                    <tr class="dark">
                                        <td class="dark text-softer ">
                                            <a class="link-noline link-tooltip" href="sumPlan.jsp" tooltip-text="Shows a status summary for a test plan." tooltip-position="left">
                                                Plan</a>
                                        </td>
                                        <td class="dark action-large ">
                                            <a href="sumPlan.jsp">
                                    ...
                                    <tr class="dark">
                                        <td class="dark text-softer ">
                                            <a class="link-noline link-tooltip" href="sumProject.jsp" tooltip-text="Shows a status summary and overview for the project." tooltip-position="left">
                                                Project</a>
                                        </td>
                                        <td class="dark action-large ">
                                            <a href="sumProject.jsp">
                                                <div class="icon-add"></div>
                                            </a>
                                        </td>
                                    </tr>
                                    <tr class="dark">
                                        <td class="dark text-softer darkSelected">
                                            <a class="link-noline link-tooltip" href="sumRun.jsp" tooltip-text="Shows a status summary and overview for test runs." tooltip-position="left">
                                                Runs</a>
                                        </td>
                        ...
                        <div style="margin-left: 10px">
                            <table class="grid create-report">
                                ...
                                <tbody><tr class="dark">
                                        <td class="dark text-softer ">
                                            <a class="link-noline link-tooltip" href="sumWorkload_Tester.jsp" tooltip-text="Shows the current workload for users." tooltip-position="left">
                                                Workload Summary</a>
                                        </td>
                                        <td class="dark action-large ">
                                            <a href="sumWorkload_Tester.jsp">
                                                <div class="icon-add"></div>
                                            </a>
                                        </td>
                                    </tr>
        ...
        <script type="text/javascript">
            ...
            Consts.ajaxCsrf = 'z51xCVlbXxse1qTvHf/r';
        ...
        <div id="tooltip" class="tooltip" style="display: none;">
            ...
            <div class="dialog-body">
                ...
                <form action="index.php?/admin/users/accept_data_processing_agreement" id="dpa_form" method="post">        <input type="hidden" name="_token" value="z51xCVlbXxse1qTvHf/r">
        ...
        <div class="dialog" id="trEnterpriseDialog" style="width: 350px; word-wrap: break-word">
            <div class="dialog-title"></div>
            <form action="index.php?/mysettings/tr_enterprise_banner_setting" id="tr_enterprise_form" method="post">    <input type="hidden" name="_token" value="z51xCVlbXxse1qTvHf/r">    <div class="dialog-body">
                    <p style="margin: 0" class="dialog-message"></p>
                    <div class="form-group">
                        <div class="radio">
                            <label>
