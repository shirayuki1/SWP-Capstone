<%-- 
    Document   : adminTestRun
    Created on : Oct 25, 2022, 10:23:19 AM
    Author     : phuon
--%>
            ...
            <div id="body" class="table" style="display: table;">
                            ...
                            <div class="empty-content empty-info">
                                ...
                                <div class="empty-body">
                                    ...
                                    <div class="button-group">
                                        <a class="button button-left button-add" href="adminAddTestRun.jsp">
                                            Add Test Run						</a>
                                    </div>
                                </div>
                            </div>
                ...
                <div id="sidebar" class="column sidebar" style="width: 250px">
                    ...
                    <div class="sidebar-inner">
                        <a id="navigation-runs-add" class="sidebar-button bottom" href="adminAddTestRun.jsp">
                            <span>Add Test Run</span>
                        </a>
                        <a id="navigation-plans-add" class="sidebar-button" href="addTestPlan.jsp">
