<%-- 
    Document   : sumMilestone_Tester
    Created on : Nov 5, 2022, 1:08:41 PM
    Author     : phuon
--%>
                    ...
                    <div id="content-inner" class="content-inner goals-clear">
                        ...
                        <div class="report-box report-box-highlighted icon-form-32">
                            ...
                            <div class="report-box-intro">
                                ...
                                <p style="margin-bottom: 0">Shows a summary and overview for a milestone. Please see the Report Options section below to configure the report specific options.</p>
                            </div>
                        </div>
                        ...
                        <form action="index.php?/reports/add_job/1&amp;plugin=milestones_summary" method="post"><input type="hidden" name="_token" value="z51xCVlbXxse1qTvHf/r">
                            <div class="form-group form-group-main">
                                <label for="name">Name		<span class="form-required">*</span></label>
                                <input class="form-control " type="text" name="name" id="name" maxlength="250" value="Milestone (Summary) %date%">
                            ...
                            <div class="report-form">
                                ...
                                <div class="tabs">
                                    <div class="tab-header">
                                        <a href="javascript:void(0)" class="tab1 current" rel="1" onclick="App.Tabs.activate(this)">Milestone &amp; Details</a>
                                        <a href="javascript:void(0)" class="tab2 " rel="2" onclick="App.Tabs.activate(this)">Activity</a>
                                    ...
                                    <div class="tab-body tab-frame">
                                        <div class="tab tab1 ">
                                            ...
                                            <p class="top">Use the following milestone:	<span class="form-required">*</span></p>
                                            <div style="margin-left: 15px">
                                                <select class="form-control form-select " id="custom_milestones_id" name="custom_milestones_id" style="width: 450px">
                                                    <option value=""></option>
                                                </select>
                                            </div>
                                            <p>Include the following details/sections:</p>
...
person2@example.com</textarea>
        ...
        <div id="tooltip" class="tooltip" style="width: 190px; top: 306.312px; left: 811.333px; display: none;">
            ...
            <p style="margin: 0">Shows the test cases grouped by a selectable attribute.</p>
