<%-- 
    Document   : comparisonReferences_Tester
    Created on : Nov 5, 2022, 1:07:55 PM
    Author     : phuon
--%>
                    ...
                    <div id="content-inner" class="content-inner goals-clear">
                        ...
                        <div class="report-box report-box-highlighted icon-form-32">
                            ...
                            <div class="report-box-intro">
                                ...
                                <p style="margin-bottom: 0">Shows the results for references in a coverage &amp; comparison matrix. Please see the Report Options section below to configure the report specific options.</p>
                            </div>
                        </div>
                        ...
                        <form action="index.php?/reports/add_job/1&amp;plugin=references_result_coverage" method="post"><input type="hidden" name="_token" value="z51xCVlbXxse1qTvHf/r">
                            <div class="form-group form-group-main">
                                <label for="name">Name		<span class="form-required">*</span></label>
                                <input class="form-control " type="text" name="name" id="name" maxlength="250" value="Comparison for References (Results) %date%">
                                    ...
                                    <div class="tab-body tab-frame">
                                        ...
                                        <div class="tab tab3 hidden">
                                            ...
                                            <div class="checkbox form-checkbox" style="margin-left: 15px">
                                                <label>
                                                    The test results for each selected test run / result <em>(comparison)</em>					<input type="checkbox" id="custom_cases_include_comparison" name="custom_cases_include_comparison" value="1" checked="checked">
                                                </label>
                                            </div>
                                            <div class="checkbox" style="margin-left: 15px">
                                                <label>
                                                    The latest/combined test result for the selected test runs <em>(status)</em>					<input type="checkbox" id="custom_cases_include_coverage" name="custom_cases_include_coverage" value="1" checked="checked">
                                                </label>
                                            </div>
