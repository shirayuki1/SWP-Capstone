<%-- 
    Document   : adminPJOverview
    Created on : Oct 25, 2022, 8:57:27 AM
    Author     : phuon
--%>
        ...
        <div id="top">
            ...
            <div class="top-section top-section-with-return text-ppp">
                <span id="return"><a
                        ...
                        href="adminDashboard.jsp">&larr; Return to Dashboard</a></span>
                <a class="link-noline" id="navigation-project"
                   href="adminPJOverview.jsp">aaaa</a>
            </div>
        </div>
                ...
                <div id="content" class="column content overflow-content">
                    ...
                    <div id="content-header" class="content-header content-header-default">
                        <div class="content-header-inner">
                            ...
                            <div class="toolbar content-header-toolbar"><a class="toolbar-button toolbar-button-last content-header-button button-edit" href="editProject.jsp">Edit</a><a class="toolbar-button toolbar-button-last content-header-button button-report dropdownLink toolbar-button-first" href="#reportDropdown">Reports<span class="caret button-caret"></span></a></div>		                                    		<div class="content-header-title page_title">
                                aaaa					</div>
                        </div>
                    </div>
                    <script type="text/javascript">
                        ...
                        <div id="reportDropdown" class="dropdown dropdown-menu dropdown-menu-grouped" style="width: 225px">
                            ...
                            <ul>
                                <li class="link-tooltip" tooltip-position="left"
                                    ...
                                    <a class="dropdown-menu-link dropdown-menu-link-report" href="defectsSummary.jsp">
                                        Summary			</a>
                                </li>
                                <li class="dropdown-menu-separator"></li>
                                <li class="link-tooltip" tooltip-position="left"
                                    tooltip-text="Shows a summary of found defects per test case &amp; test.">
                                    <a class="dropdown-menu-link dropdown-menu-link-report" href="summaryForCases.jsp">
                                        Summary for Cases			</a>
                                </li>
                                <li class="dropdown-menu-separator"></li>
                                <li class="link-tooltip" tooltip-position="left"
                                    tooltip-text="Shows a summary of found defects for the references (requirements, user stories, etc.) in this project.">
                                    <a class="dropdown-menu-link dropdown-menu-link-report" href="summaryForReference.jsp">
                            ...
                            <ul>
                                <li class="link-tooltip" tooltip-position="left"
                                    ...
                                    <a class="dropdown-menu-link dropdown-menu-link-report" href="comparisonForCases.jsp">
                                ...
                                <li class="link-tooltip" tooltip-position="left"
                                    ...
                                    <a class="dropdown-menu-link dropdown-menu-link-report" href="comparisonForReference.jsp">
                                ...
                                <li class="link-tooltip" tooltip-position="left"
                                    ...
                                    <a class="dropdown-menu-link dropdown-menu-link-report" href="resultPropDistribution.jsp">
                            ...
                            <ul>
                                <li class="link-tooltip" tooltip-position="left"
                                    ...
                                    <a class="dropdown-menu-link dropdown-menu-link-report" href="summaryProjects.jsp">
                                        Summary			</a>
                                </li>
                            </ul>
                            ...
                            <ul>
                                <li class="link-tooltip" tooltip-position="left"
                                    ...
                                    <a class="dropdown-menu-link dropdown-menu-link-report" href="summaryWorkload.jsp">
                                        Workload Summary			</a>
                                </li>
                            </ul>
                        </div>
                        ...
                        <div id="content_container">
                            <div class="table">
                                <div class="column column-p2 column-pad-right">
                                    <h1 class="top"><a id="navigation-overview-viewmilestones" class="nolink" href="adminMilestone.jsp">Milestones</a></h1>
                                    <p>This project doesn't have any active milestones.
                                        You can add a new milestone.</p>
                                    <div class="button-group">
                                        <a id="navigation-overview-addmilestones" href="addMilestone.jsp"
                                           class="button button-left button-add">
                                            Add Milestone					</a>
                                    </div>
                                </div>
                                <div class="column column-p2 column-pad-left">
                                    <h1 class="top"><a id="navigation-overview-runs" class="nolink" href="adminTestRun.jsp">Test Runs</a></h1>
                                    <p>This project doesn't have any active test
                                        runs. You can add a new test run.</p>
                                    <div class="button-group">
                                        <a id="navigation-overview-addrunssuite" href="adminAddTestRun.jsp"
                                           class="button button-left button-add">
                                            Add Test Run						</a>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="column summary-column summary-column-first">
                                    <div class="summary-title summary-title-compact">
                                        <a id="sidebar-milestones-overview" href="adminMilestone.jsp">Milestones</a>
                                    </div>
                                    <div class="summary-description-compact text-secondary">
                                        <a id="sidebar-milestones-add" class="link" href="addMilestone.jsp">Add</a> |
                                        <a id="sidebar-milestones-viewall" class="link" href="#viewMilestone">View All</a>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="column summary-column">
                                    <div class="summary-title summary-title-compact">
                                        <a id="sidebar-runs-overview" href="adminTestRun.jsp">Test Runs</a>
                                    </div>
                                    <div class="summary-description-compact text-secondary">
                                        <a id="sidebar-runs-add" class="link"
                                           href="adminAddTestRun.jsp"
                                           >Add</a> |
                                        <a id="sidebar-runs-viewall" class="link" href="#viewTestRun">View All</a>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="column summary-column summary-column-last">
                                    <div class="summary-title summary-title-compact">
                                        <a id="sidebar-cases-overview" href="adminTestCase.jsp">Test Cases</a>
                                    </div>
                                    <div class="summary-description-compact text-secondary">
                                        <a id="sidebar-cases-add" class="link" href="addTestCase.jsp">Add</a> |
                                        <a id="sidebar-suites-viewall" class="link" href="#viewTestCases">View All</a>
                                    </div>
                                </div>
                            </div>
                        </div>
