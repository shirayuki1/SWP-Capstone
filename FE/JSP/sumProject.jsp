<%-- 
    Document   : sumProject
    Created on : Nov 5, 2022, 1:09:08 PM
    Author     : phuon
--%>
                    ...
                    <div id="content-inner" class="content-inner goals-clear">
                        ...
                        <div class="report-box report-box-highlighted icon-form-32">
                            ...
                            <div class="report-box-intro">
                                ...
                                <p style="margin-bottom: 0">Shows a summary and overview for the project. Please see the Report Options section below to configure the report specific options.</p>
                            </div>
                        </div>
                        ...
                        <form action="index.php?/reports/add_job/1&amp;plugin=projects_summary" method="post"><input type="hidden" name="_token" value="z51xCVlbXxse1qTvHf/r">
                            <div class="form-group form-group-main">
                                <label for="name">Name		<span class="form-required">*</span></label>
                                <input class="form-control " type="text" name="name" id="name" maxlength="250" value="Project (Summary) %date%">
                            ...
                            <div class="report-form">
                                ...
                                <div class="tabs">
                                    <div class="tab-header">
                                        <a href="javascript:void(0)" class="tab1 current" rel="1" onclick="App.Tabs.activate(this)">Details</a>
                                        <a href="javascript:void(0)" class="tab2 " rel="4" onclick="App.Tabs.activate(this)">History</a>
                                        <a href="javascript:void(0)" class="tab3 " rel="3" onclick="App.Tabs.activate(this)">Activity</a>
                                    </div>
                                    <div class="tab-body tab-frame">
                                        <div class="tab tab1 ">
                                            <p class="top">Include the following milestones:</p>
                                            <div class="checkbox form-checkbox" style="margin-left: 15px">
                                                <label>
                                                    Open milestones					<input type="checkbox" id="custom_milestones_active_include" name="custom_milestones_active_include" value="1" checked="checked">
                                                </label>
                                            </div>
                                            <div class="checkbox form-checkbox" style="margin-left: 15px">
                                                <label>
                                                    Completed milestones					<input type="checkbox" id="custom_milestones_completed_include" name="custom_milestones_completed_include" value="1">
                                                </label>
                                            </div>
                                            <div style="margin-left: 35px">
                                                ...
                                                <p class="top">Maximum number to display:</p>
                                                <div style="margin-left: 15px">
                                                    <select class="form-control form-select " id="custom_milestones_completed_limit" name="custom_milestones_completed_limit" style="width: 200px">
                                                        <option value="5">
                                                            5			</option>
                                            ...
                                            <p>Include the following test runs &amp; plans:</p>
                                            <div class="checkbox form-checkbox" style="margin-left: 15px">
                                                <label>
                                                    Open runs &amp; plans					<input type="checkbox" id="custom_runs_active_include" name="custom_runs_active_include" value="1" checked="checked">
                                                </label>
                                            </div>
                                            <div class="checkbox form-checkbox" style="margin-left: 15px">
                                                <label>
                                                    Completed runs &amp; plans					<input type="checkbox" id="custom_runs_completed_include" name="custom_runs_completed_include" value="1">
                                                </label>
                                            </div>
                                            <div style="margin-left: 35px">
                                                ...
                                                <p class="top">Maximum number to display:</p>
                                                <div style="margin-left: 15px">
                                                    <select class="form-control form-select " id="custom_runs_completed_limit" name="custom_runs_completed_limit" style="width: 200px">
                                                        <option value="5">
                                                            5			</option>
                                                        <option value="10" selected="selected">
                                                            10			</option>
                                            ...
                                            <p>Include the following additional sections:</p>
                                            <div class="checkbox form-checkbox" style="margin-left: 15px">
                                                <label>
                                                    History and project events					<input type="checkbox" id="custom_history_include" name="custom_history_include" value="1" checked="checked">
                                                </label>
                                            </div>
                                        ...
                                        <div class="tab tab2 hidden">
                                            ...
                                            <div style="margin-left: 15px">
                                                <select class="form-control form-select " id="custom_history_daterange" name="custom_history_daterange" style="width: 200px">
                                            ...
                                            <div style="margin-left: 15px; margin-top: 8px" id="custom_history_daterange_from_container" class="hidden">
                                                <div style="float: left; line-height: 150%">
                                                    From:	</div>
                                                <div style="margin-left: 50px">
                                                    <input class="form-control datepicker hasDatepicker" type="text" style="width: 125px" name="custom_history_daterange_from" id="custom_history_daterange_from" value="">
                                                </div>
                                                <div style="clear: both"></div>
                                            </div>
                                            <div style="margin-left: 15px; margin-top: 8px" id="custom_history_daterange_to_container" class="hidden">
                                                <div style="float: left; line-height: 150%">
                                                    To:<br>
                                                </div>
                                                <div style="margin-left: 50px">
                                                    <input class="form-control datepicker hasDatepicker" type="text" style="width: 125px" name="custom_history_daterange_to" id="custom_history_daterange_to" value="">
                                                </div>
                                                <div style="clear: both"></div>
                                            </div>
                                            ...
                                            <script type="text/javascript">
                                                $(document).ready(
                                                        function()
                                                        {
                                                        $('#custom_history_daterange').change(
                                                                function()
                                                                {
                                                                var type_id = $(this).val();
                                                                if (type_id == 2)
                                                                {
                                                                $('#custom_history_daterange_from_container').show();
                                                                $('#custom_history_daterange_to_container').show();
                                                                }
                                                                else
                                                                {
                                                                $('#custom_history_daterange_from').val('');
                                                                $('#custom_history_daterange_from_container').hide();
                                                                $('#custom_history_daterange_to').val('');
                                                                $('#custom_history_daterange_to_container').hide();
                                                                }
                                                                }
                                                        );
                                                        App.applyDatepicker(
                                                                $('#custom_history_daterange_from_container')
                                                                );
                                                        App.applyDatepicker(
                                                                $('#custom_history_daterange_to_container')
                                                                );
                                                        }
                                                );
                                            </script>
                                            ...
                                            <p class="">Maximum number of history items to display:</p>
                                            <div style="margin-left: 15px">
                                                <select class="form-control form-select " id="custom_history_limit" name="custom_history_limit" style="width: 200px">
                                                    <option value="10">
                                                        10			</option>
                                                    <option value="25">
                                                        25			</option>
