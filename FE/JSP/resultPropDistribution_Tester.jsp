<%-- 
    Document   : resultPropDistribution_Tester
    Created on : Nov 5, 2022, 1:08:24 PM
    Author     : phuon
--%>
                    ...
                    <div id="content-inner" class="content-inner goals-clear">
                        ...
                        <div class="report-box report-box-highlighted icon-form-32">
                            ...
                            <div class="report-box-intro">
                                ...
                                <p style="margin-bottom: 0">Shows a summary of tests, grouped by a selectable attribute, for a given project, milestone or specific test runs. Please see the Report Options section below to configure the report specific options.</p>
                            </div>
                        </div>
                        ...
                        <form action="index.php?/reports/add_job/1&amp;plugin=tests_property_groups" method="post"><input type="hidden" name="_token" value="z51xCVlbXxse1qTvHf/r">
                            <div class="form-group form-group-main">
                                <label for="name">Name		<span class="form-required">*</span></label>
                                <input class="form-control " type="text" name="name" id="name" maxlength="250" value="Property Distribution (Results) %date%">
                            ...
                            <div class="report-form">
                                ...
                                <div class="tabs">
                                    <div class="tab-header">
                                        <a href="javascript:void(0)" class="tab1 current" rel="1" onclick="App.Tabs.activate(this)">Grouping</a>
                                        <a href="javascript:void(0)" class="tab2 " rel="2" onclick="App.Tabs.activate(this)">
                                            Sections &amp; Test Runs					</a>
                                        <a href="javascript:void(0)" class="tab3 " rel="3" onclick="App.Tabs.activate(this)">Tests</a>
                                    </div>
                                    <div class="tab-body tab-frame">
                                        <div class="tab tab1 ">
                                            ...
                                            <p class="top">Group the tests by:</p>
                                            <div style="margin-left: 15px">
                                                <select class="form-control form-select " id="custom_tests_groupby" name="custom_tests_groupby" style="width: 200px">
                                                    <option value="tests:assignedto_id">
                                                        Assigned To		</option>
                                                    <option value="cases:custom_automation_type">
                                                        Automation Type		</option>
                                                    <option value="cases:priority_id">
                                                        Priority		</option>
                                                    <option value="tests:status_id" selected="selected">
                                                        Status		</option>
                                                    <option value="cases:template_id">
                                                        Template		</option>
                                                    <option value="tests:tested_by">
                                                        Tested By		</option>
                                                    <option value="cases:type_id">
                                                        Type		</option>
                                                </select>
                                            </div>
                                            ...
                                            <div class="checkbox form-checkbox" style="margin-left: 15px">
                                                <label>
                                                    An aggregated summary of groups					<input type="checkbox" id="custom_tests_include_summary" name="custom_tests_include_summary" value="1" checked="checked">
                                                </label>
                                            </div>
                                            <div class="checkbox" style="margin-left: 15px">
                                                <label>
                                                    The test details per group					<input type="checkbox" id="custom_tests_include_details" name="custom_tests_include_details" value="1" checked="checked">
                                                </label>
                                            </div>
                                        </div>
                                        <div class="tab tab2 hidden">
                                            ...
                                            <div class="radio form-radio" style="margin-left: 15px">
                                                <label>
                                                    All sections			<input type="radio" id="custom_runs_sections_include_all" name="custom_runs_sections_include" value="1" checked="checked">
                                                </label>
                                            </div>
                                            <div class="radio form-radio" style="margin-left: 15px">
                                                <label>
                                                    The following sections only:			<input type="radio" id="custom_runs_sections_include_selected" name="custom_runs_sections_include" value="2">
                                                </label>
                                            </div>
                                            <div style="margin-left: 35px">
                                                <select class="form-control form-select " id="custom_runs_sections_ids" name="custom_runs_sections_ids[]" style="width: 100%; height: 200px" multiple="multiple">
                                                </select>
                                            ...
                                            <p class="">Include the test results of:</p>
                                            <div class="radio form-radio" style="margin-left: 15px">
                                                <label>
                                        ...
                                        <div class="tab tab3 hidden">
                                            ...
                                            <p class="">Maximum number of tests to display (per group):</p>
                                            <div style="margin-left: 15px">
                            ...
                            <div class="report-box report-box-stacked report-box-stacked-last icon-notification-32">
                                ...
                                <div class="report-box-controls">
                                    ...
                                    <div id="notifyLinkContainer" class="form-group">
                                        <div class="checkbox form-checkbox" style="margin-left: 15px">
                                            <label>
                                                Email a link to the report (requires TestRail access):					<input type="checkbox" id="notify_link" name="notify_link" value="1" disabled="disabled">
                                            </label>
                                        </div>
                                        <div style="margin-left: 35px">
