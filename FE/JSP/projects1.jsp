<%-- 
    Document   : projects1
    Created on : Oct 20, 2022, 4:34:38 PM
    Author     : phuon
--%>
            ...
            <div class="w3-container">
                <div class="w3-row" style="margin-top: 20px;">
                    ...
                    <div id="RUNS_RESULTS" class="w3-container city" style="display:none">
                        ...
                        <section class="border-content" style="border: 1px solid #9fc0d8; width:  900px; padding: 10px;">
                            <h2><small>What's a test run?</small></h2>
                            <p style="display: inline-block; margin-right: 20px">Once you have started adding test cases, you can start a test run to execute <br>
                                your tests and track results.</p>
                            <a href="addTestRun1.jsp" 
                               style="text-decoration: none; background-color: #376789; border-radius: 3px;  margin-left: 90px;
                               padding-top: 7px; padding-bottom: 7px; padding-left: 20px; padding-right: 20px">
                                Add Test Run
                            </a>
